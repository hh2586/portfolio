var THREE = function(e) {
    ...
    Object.assign(a.prototype, {
        ...
        multiplyMatrices: function(e, t) {
            var n = e.elements,
                ...
                M = i[5],
                b = i[8];
            return r[0] = a * f + o * v + s * y, r[3] = a * m + o * _ + s * M, r[6] = a * g + o * x + s * b, r[1] = l * f + c * v + h * y, r[4] = l * m + c * _ + h * M, r[7] = l * g + c * x + h * b, r[2] = u * f + d * v + p * y, r[5] = u * m + d * _ + p * M, r[8] = u * g + d * x + p * b, this
        },
        multiplyScalar: function(e) {
            var t = this.elements;
        ...
        getInverse: function(e, t) {
            ...
            var v = 1 / g;
            return i[0] = p * v, i[1] = (o * u - d * a) * v, i[2] = (c * a - o * l) * v, i[3] = f * v, i[4] = (d * r - o * h) * v, i[5] = (o * s - c * r) * v, i[6] = m * v, i[7] = (a * h - u * r) * v, i[8] = (l * r - a * s) * v, this
        },
        transpose: function() {
    ...
    function h(e, t, n, i, a, l, u, d, p, f) {
        Object.defineProperty(this, "id", {
            value: c++
        }), this.uuid = r.generateUUID(), this.name = "", this.image = void 0 !== e ? e : h.DEFAULT_IMAGE, this.mipmaps = [], this.mapping = void 0 !== t ? t : h.DEFAULT_MAPPING, this.wrapS = void 0 !== n ? n : 1001, this.wrapT = void 0 !== i ? i : 1001, this.magFilter = void 0 !== a ? a : 1006, this.minFilter = void 0 !== l ? l : 1008, this.anisotropy = void 0 !== p ? p : 1, this.format = void 0 !== u ? u : 1023, this.internalFormat = null, this.type = void 0 !== d ? d : 1009, this.offset = new o(0, 0), this.repeat = new o(1, 1), this.center = new o(0, 0), this.rotation = 0, this.matrixAutoUpdate = !0, this.matrix = new s, this.generateMipmaps = !0, this.premultiplyAlpha = !1, this.flipY = !0, this.unpackAlignment = 4, this.encoding = void 0 !== f ? f : 3e3, this.version = 0, this.onUpdate = null
    }

    function u(e, t, n, i, r, a, o, s, l, c, u, d) {
        h.call(this, null, a, o, s, l, c, i, r, u, d), this.image = {
            data: e || null,
            width: t || 1,
            height: n || 1
    ...
    h.DEFAULT_IMAGE = void 0, h.DEFAULT_MAPPING = 300, h.prototype = Object.assign(Object.create(a.prototype), {
        constructor: h,
        isTexture: !0,
        ...
        toJSON: function(e) {
            ...
            if (void 0 !== this.image) {
                var i = this.image;
                if (void 0 === i.uuid && (i.uuid = r.generateUUID()), !t && void 0 === e.images[i.uuid]) {
                    var a;
                    if (Array.isArray(i)) {
                        a = [];
                        for (var o = 0, s = i.length; o < s; o++) a.push(l(i[o]))
                    } else a = l(i);
                    e.images[i.uuid] = {
                        uuid: i.uuid,
                        url: a
    ...
    }), u.prototype = Object.create(h.prototype), u.prototype.constructor = u, u.prototype.isDataTexture = !0, Object.assign(d, {
        ...
        slerpFlat: function(e, t, n, i, r, a, o) {
            ...
            if (h !== f || s !== u || l !== d || c !== p) {
                ...
                var M = o * v;
                if (s = s * m + u * M, l = l * m + d * M, c = c * m + p * M, h = h * m + f * M, m === 1 - o) {
        ...
        setFromRotationMatrix: function(e) {
            var t, n = e.elements,
                ...
                u = n[10],
                d = i + s + u;
            return d > 0 ? (t = .5 / Math.sqrt(d + 1), this._w = .25 / t, this._x = (h - l) * t, this._y = (a - c) * t, this._z = (o - r) * t) : i > s && i > u ? (t = 2 * Math.sqrt(1 + i - s - u), this._w = (h - l) / t, this._x = .25 * t, this._y = (r + o) / t, this._z = (a + c) / t) : s > u ? (t = 2 * Math.sqrt(1 + s - i - u), this._w = (a - c) / t, this._x = (r + o) / t, this._y = .25 * t, this._z = (l + h) / t) : (t = 2 * Math.sqrt(1 + u - i - s), this._w = (o - r) / t, this._x = (a + c) / t, this._y = (l + h) / t, this._z = .25 * t), this._onChangeCallback(), this
        },
    ...
    Object.assign(m.prototype, {
        ...
        applyEuler: function(e) {
            return e && e.isEuler || console.error("THREE.Vector3: .applyEuler() now expects an Euler rotation rather than a Vector3 and order."), this.applyQuaternion(f.setFromEuler(e))
        },
        ...
        projectOnPlane: function(e) {
            return p.copy(this).projectOnVector(e), this.sub(p)
        },
        reflect: function(e) {
    ...
    function R(e, t) {
        this.min = void 0 !== e ? e : new m(1 / 0, 1 / 0, 1 / 0), this.max = void 0 !== t ? t : new m(-1 / 0, -1 / 0, -1 / 0)
    }
    ...
    Object.assign(R.prototype, {
        ...
        setFromArray: function(e) {
            for (var t = 1 / 0, n = 1 / 0, i = 1 / 0, r = -1 / 0, a = -1 / 0, o = -1 / 0, s = 0, l = e.length; s < l; s += 3) {
                var c = e[s],
                    h = e[s + 1],
                    u = e[s + 2];
                c < t && (t = c), h < n && (n = h), u < i && (i = u), c > r && (r = c), h > a && (a = h), u > o && (o = u)
            }
        ...
        getCenter: function(e) {
            return void 0 === e && (console.warn("THREE.Box3: .getCenter() target is now required"), e = new m), this.isEmpty() ? e.set(0, 0, 0) : e.addVectors(this.min, this.max).multiplyScalar(.5)
        },
        getSize: function(e) {
            return void 0 === e && (console.warn("THREE.Box3: .getSize() target is now required"), e = new m), this.isEmpty() ? e.set(0, 0, 0) : e.subVectors(this.max, this.min)
        },
        ...
        expandByObject: function(e) {
            ...
            var t = e.geometry;
            void 0 !== t && (null === t.boundingBox && t.computeBoundingBox(), _.copy(t.boundingBox), _.applyMatrix4(e.matrixWorld), this.union(_));
        ...
        getParameter: function(e, t) {
            return void 0 === t && (console.warn("THREE.Box3: .getParameter() target is now required"), t = new m), t.set((e.x - this.min.x) / (this.max.x - this.min.x), (e.y - this.min.y) / (this.max.y - this.min.y), (e.z - this.min.z) / (this.max.z - this.min.z))
        },
        intersectsBox: function(e) {
            return !(e.max.x < this.min.x || e.min.x > this.max.x || e.max.y < this.min.y || e.min.y > this.max.y || e.max.z < this.min.z || e.min.z > this.max.z)
        },
        intersectsSphere: function(e) {
            return this.clampPoint(e.center, v), v.distanceToSquared(e.center) <= e.radius * e.radius
        },
        ...
        intersectsTriangle: function(e) {
            ...
            this.getCenter(w), T.subVectors(this.max, w), x.subVectors(e.a, w), y.subVectors(e.b, w), M.subVectors(e.c, w), b.subVectors(y, x), E.subVectors(M, y), S.subVectors(x, M);
            var t = [0, -b.z, b.y, 0, -E.z, E.y, 0, -S.z, S.y, b.z, 0, -b.x, E.z, 0, -E.x, S.z, 0, -S.x, -b.y, b.x, 0, -E.y, E.x, 0, -S.y, S.x, 0];
            return !!P(t, x, y, M, T) && (!!P(t = [1, 0, 0, 0, 1, 0, 0, 0, 1], x, y, M, T) && (L.crossVectors(b, E), P(t = [L.x, L.y, L.z], x, y, M, T)))
        },
        clampPoint: function(e, t) {
            return void 0 === t && (console.warn("THREE.Box3: .clampPoint() target is now required"), t = new m), t.copy(e).clamp(this.min, this.max)
        },
        distanceToPoint: function(e) {
            return v.copy(e).clamp(this.min, this.max).sub(e).length()
        },
        getBoundingSphere: function(e) {
            return void 0 === e && console.error("THREE.Box3: .getBoundingSphere() target is now required"), this.getCenter(e.center), e.radius = .5 * this.getSize(v).length(), e
        },
        ...
        applyMatrix4: function(e) {
            return this.isEmpty() || (g[0].set(this.min.x, this.min.y, this.min.z).applyMatrix4(e), g[1].set(this.min.x, this.min.y, this.max.z).applyMatrix4(e), g[2].set(this.min.x, this.max.y, this.min.z).applyMatrix4(e), g[3].set(this.min.x, this.max.y, this.max.z).applyMatrix4(e), g[4].set(this.max.x, this.min.y, this.min.z).applyMatrix4(e), g[5].set(this.max.x, this.min.y, this.max.z).applyMatrix4(e), g[6].set(this.max.x, this.max.y, this.min.z).applyMatrix4(e), g[7].set(this.max.x, this.max.y, this.max.z).applyMatrix4(e), this.setFromPoints(g)), this
        },
    ...
    function C(e, t) {
        this.center = void 0 !== e ? e : new m, this.radius = void 0 !== t ? t : -1
    }
    Object.assign(C.prototype, {
        ...
        clampPoint: function(e, t) {
            ...
            return void 0 === t && (console.warn("THREE.Sphere: .clampPoint() target is now required"), t = new m), t.copy(e), n > this.radius * this.radius && (t.sub(this.center).normalize(), t.multiplyScalar(this.radius).add(this.center)), t
        },
        getBoundingBox: function(e) {
            return void 0 === e && (console.warn("THREE.Sphere: .getBoundingBox() target is now required"), e = new R), this.isEmpty() ? (e.makeEmpty(), e) : (e.set(this.center, this.center), e.expandByScalar(this.radius), e)
        },
        applyMatrix4: function(e) {
    ...
    function F(e, t) {
        this.normal = void 0 !== e ? e : new m(1, 0, 0), this.constant = void 0 !== t ? t : 0
    }
    Object.assign(F.prototype, {
        ...
        projectPoint: function(e, t) {
            return void 0 === t && (console.warn("THREE.Plane: .projectPoint() target is now required"), t = new m), t.copy(this.normal).multiplyScalar(-this.distanceToPoint(e)).add(e)
        },
        intersectLine: function(e, t) {
            void 0 === t && (console.warn("THREE.Plane: .intersectLine() target is now required"), t = new m);
            var n = e.delta(N),
                i = this.normal.dot(n);
        ...
        coplanarPoint: function(e) {
            return void 0 === e && (console.warn("THREE.Plane: .coplanarPoint() target is now required"), e = new m), e.copy(this.normal).multiplyScalar(-this.constant)
        },
    ...
    Object.assign(B.prototype, {
        ...
        setFromProjectionMatrix: function(e) {
            var t = this.planes,
                ...
                v = n[14],
                _ = n[15];
            return t[0].setComponents(o - i, h - s, f - u, _ - m).normalize(), t[1].setComponents(o + i, h + s, f + u, _ + m).normalize(), t[2].setComponents(o + r, h + l, f + d, _ + g).normalize(), t[3].setComponents(o - r, h - l, f - d, _ - g).normalize(), t[4].setComponents(o - a, h - c, f - p, _ - v).normalize(), t[5].setComponents(o + a, h + c, f + p, _ + v).normalize(), this
        },
        intersectsObject: function(e) {
            var t = e.geometry;
            return null === t.boundingSphere && t.computeBoundingSphere(), O.copy(t.boundingSphere).applyMatrix4(e.matrixWorld), this.intersectsSphere(O)
        },
        intersectsSprite: function(e) {
            return O.center.set(0, 0, 0), O.radius = .7071067811865476, O.applyMatrix4(e.matrixWorld), this.intersectsSphere(O)
        },
        intersectsSphere: function(e) {
        ...
        intersectsBox: function(e) {
            for (var t = this.planes, n = 0; n < 6; n++) {
                var i = t[n];
                if (z.x = i.normal.x > 0 ? e.max.x : e.min.x, z.y = i.normal.y > 0 ? e.max.y : e.min.y, z.z = i.normal.z > 0 ? e.max.z : e.min.z, i.distanceToPoint(z) < 0) return !1
            }
            return !0
        },
        containsPoint: function(e) {
    ...
    Object.assign(Y.prototype, {
        ...
        set: function(e, t, n, i, r, a, o, s, l, c, h, u, d, p, f, m) {
            var g = this.elements;
            return g[0] = e, g[4] = t, g[8] = n, g[12] = i, g[1] = r, g[5] = a, g[9] = o, g[13] = s, g[2] = l, g[6] = c, g[10] = h, g[14] = u, g[3] = d, g[7] = p, g[11] = f, g[15] = m, this
        },
        identity: function() {
        ...
        makeRotationFromEuler: function(e) {
            ...
            if ("XYZ" === e.order) {
                var u = a * c,
                    ...
                    p = o * c,
                    f = o * h;
                t[0] = s * c, t[4] = -s * h, t[8] = l, t[1] = d + p * l, t[5] = u - f * l, t[9] = -o * s, t[2] = f - u * l, t[6] = p + d * l, t[10] = a * s
            } else if ("YXZ" === e.order) {
                var m = s * c,
                    g = s * h,
                    v = l * c,
                    _ = l * h;
                t[0] = m + _ * o, t[4] = v * o - g, t[8] = a * l, t[1] = a * h, t[5] = a * c, t[9] = -o, t[2] = g * o - v, t[6] = _ + m * o, t[10] = a * s
            } else if ("ZXY" === e.order) {
                m = s * c, g = s * h, v = l * c, _ = l * h;
                t[0] = m - _ * o, t[4] = -a * h, t[8] = v + g * o, t[1] = g + v * o, t[5] = a * c, t[9] = _ - m * o, t[2] = -a * l, t[6] = o, t[10] = a * s
            } else if ("ZYX" === e.order) {
                u = a * c, d = a * h, p = o * c, f = o * h;
                t[0] = s * c, t[4] = p * l - d, t[8] = u * l + f, t[1] = s * h, t[5] = f * l + u, t[9] = d * l - p, t[2] = -l, t[6] = o * s, t[10] = a * s
            } else if ("YZX" === e.order) {
                var x = a * s,
                    y = a * l,
                    M = o * s,
                    b = o * l;
                t[0] = s * c, t[4] = b - x * h, t[8] = M * h + y, t[1] = h, t[5] = a * c, t[9] = -o * c, t[2] = -l * c, t[6] = y * h + M, t[10] = x - b * h
            } else if ("XZY" === e.order) {
                x = a * s, y = a * l, M = o * s, b = o * l;
                t[0] = s * c, t[4] = -h, t[8] = l * c, t[1] = x * h + b, t[5] = a * c, t[9] = y * h - M, t[2] = M * h - y, t[6] = o * c, t[10] = b * h + x
            }
        ...
        lookAt: function(e, t, n) {
            var i = this.elements;
            return j.subVectors(e, t), 0 === j.lengthSq() && (j.z = 1), j.normalize(), W.crossVectors(n, j), 0 === W.lengthSq() && (1 === Math.abs(n.z) ? j.x += 1e-4 : j.z += 1e-4, j.normalize(), W.crossVectors(n, j)), W.normalize(), X.crossVectors(j, W), i[0] = W.x, i[4] = X.x, i[8] = j.x, i[1] = W.y, i[5] = X.y, i[9] = j.y, i[2] = W.z, i[6] = X.z, i[10] = j.z, this
        },
        multiply: function(e, t) {
        ...
        multiplyMatrices: function(e, t) {
            var n = e.elements,
                ...
                I = i[11],
                F = i[15];
            return r[0] = a * M + o * w + s * R + l * N, r[4] = a * b + o * T + s * P + l * U, r[8] = a * E + o * L + s * D + l * I, r[12] = a * S + o * A + s * C + l * F, r[1] = c * M + h * w + u * R + d * N, r[5] = c * b + h * T + u * P + d * U, r[9] = c * E + h * L + u * D + d * I, r[13] = c * S + h * A + u * C + d * F, r[2] = p * M + f * w + m * R + g * N, r[6] = p * b + f * T + m * P + g * U, r[10] = p * E + f * L + m * D + g * I, r[14] = p * S + f * A + m * C + g * F, r[3] = v * M + _ * w + x * R + y * N, r[7] = v * b + _ * T + x * P + y * U, r[11] = v * E + _ * L + x * D + y * I, r[15] = v * S + _ * A + x * C + y * F, this
        },
        multiplyScalar: function(e) {
            var t = this.elements;
        ...
        getInverse: function(e, t) {
            ...
            var w = 1 / S;
            return n[0] = y * w, n[1] = (v * f * s - p * _ * s - v * o * m + a * _ * m + p * o * x - a * f * x) * w, n[2] = (c * _ * s - v * h * s + v * o * u - a * _ * u - c * o * x + a * h * x) * w, n[3] = (p * h * s - c * f * s - p * o * u + a * f * u + c * o * m - a * h * m) * w, n[4] = M * w, n[5] = (d * _ * s - g * f * s + g * o * m - r * _ * m - d * o * x + r * f * x) * w, n[6] = (g * h * s - l * _ * s - g * o * u + r * _ * u + l * o * x - r * h * x) * w, n[7] = (l * f * s - d * h * s + d * o * u - r * f * u - l * o * m + r * h * m) * w, n[8] = b * w, n[9] = (g * p * s - d * v * s - g * a * m + r * v * m + d * a * x - r * p * x) * w, n[10] = (l * v * s - g * c * s + g * a * u - r * v * u - l * a * x + r * c * x) * w, n[11] = (d * c * s - l * p * s - d * a * u + r * p * u + l * a * m - r * c * m) * w, n[12] = E * w, n[13] = (d * v * o - g * p * o + g * a * f - r * v * f - d * a * _ + r * p * _) * w, n[14] = (g * c * o - l * v * o - g * a * h + r * v * h + l * a * _ - r * c * _) * w, n[15] = (l * p * o - d * c * o + d * a * h - r * p * h - l * a * f + r * c * f) * w, this
        },
        scale: function(e) {
            var t = this.elements,
                n = e.x,
        ...
        compose: function(e, t, n) {
            var i = this.elements,
                ...
                M = n.y,
                b = n.z;
            return i[0] = (1 - (f + g)) * y, i[1] = (d + x) * y, i[2] = (p - _) * y, i[3] = 0, i[4] = (d - x) * M, i[5] = (1 - (u + g)) * M, i[6] = (m + v) * M, i[7] = 0, i[8] = (p + _) * b, i[9] = (m - v) * b, i[10] = (1 - (u + f)) * b, i[11] = 0, i[12] = e.x, i[13] = e.y, i[14] = e.z, i[15] = 1, this
        },
        decompose: function(e, t, n) {
            ...
            var s = 1 / r,
                l = 1 / a,
                c = 1 / o;
            return H.elements[0] *= s, H.elements[1] *= s, H.elements[2] *= s, H.elements[4] *= l, H.elements[5] *= l, H.elements[6] *= l, H.elements[8] *= c, H.elements[9] *= c, H.elements[10] *= c, t.setFromRotationMatrix(H), n.x = r, n.y = a, n.z = o, this
        },
    ...
    Object.assign(Q.prototype, {
        ...
        setHSL: function(e, t, n) {
            if (e = r.euclideanModulo(e, 1), t = r.clamp(t, 0, 1), n = r.clamp(n, 0, 1), 0 === t) this.r = this.g = this.b = n;
            else {
                var i = n <= .5 ? n * (1 + t) : n + t - n * t,
                    a = 2 * n - i;
                this.r = K(a, i, e + 1 / 3), this.g = K(a, i, e), this.b = K(a, i, e - 1 / 3)
            }
            return this
        },
        setStyle: function(e) {
        ...
        offsetHSL: function(e, t, n) {
            return this.getHSL(Z), Z.h += e, Z.s += t, Z.l += n, this.setHSL(Z.h, Z.s, Z.l), this
        },
        add: function(e) {
            return this.r += e.r, this.g += e.g, this.b += e.b, this
        },
    ...
    Object.defineProperties(ne.prototype, {
        ...
        setAxisAngleFromRotationMatrix: function(e) {
            ...
            if (Math.abs(s - c) < .01 && Math.abs(l - d) < .01 && Math.abs(u - p) < .01) {
                if (Math.abs(s + c) < .1 && Math.abs(l + d) < .1 && Math.abs(u + p) < .1 && Math.abs(o + h + f - 3) < .1) return this.set(1, 0, 0, 0), this;
                t = Math.PI;
                var m = (o + 1) / 2,
                    g = (h + 1) / 2,
                    v = (f + 1) / 2,
                    ...
                    x = (l + d) / 4,
                    y = (u + p) / 4;
                return m > g && m > v ? m < .01 ? (n = 0, i = .707106781, r = .707106781) : (i = _ / (n = Math.sqrt(m)), r = x / n) : g > v ? g < .01 ? (n = .707106781, i = 0, r = .707106781) : (n = _ / (i = Math.sqrt(g)), r = y / i) : v < .01 ? (n = .707106781, i = .707106781, r = 0) : (n = x / (r = Math.sqrt(v)), i = y / r), this.set(n, i, r, t), this
            }
            var M = Math.sqrt((p - u) * (p - u) + (l - d) * (l - d) + (c - s) * (c - s));
            return Math.abs(M) < .001 && (M = 1), this.x = (p - u) / M, this.y = (l - d) / M, this.z = (c - s) / M, this.w = Math.acos((o + h + f - 1) / 2), this
        },
        min: function(e) {
    ...
    function ae(e, t, n, i) {
        this._x = e || 0, this._y = t || 0, this._z = n || 0, this._order = i || ae.DefaultOrder
    }

    function oe() {
        this.mask = 1
    }
    ae.RotationOrders = ["XYZ", "YZX", "ZXY", "XZY", "YXZ", "ZYX"], ae.DefaultOrder = "XYZ", Object.defineProperties(ae.prototype, {
        x: {
            get: function() {
                return this._x
            },
        ...
        setFromRotationMatrix: function(e, t, n) {
            ...
            switch (t = t || this._order) {
                case "XYZ":
                    this._y = Math.asin(i(l, -1, 1)), Math.abs(l) < .9999999 ? (this._x = Math.atan2(-u, f), this._z = Math.atan2(-s, o)) : (this._x = Math.atan2(p, h), this._z = 0);
                    break;
                case "YXZ":
                    this._x = Math.asin(-i(u, -1, 1)), Math.abs(u) < .9999999 ? (this._y = Math.atan2(l, f), this._z = Math.atan2(c, h)) : (this._y = Math.atan2(-d, o), this._z = 0);
                    break;
                case "ZXY":
                ...
                case "ZYX":
                    ...
                    break;
                case "YZX":
                    this._z = Math.asin(i(c, -1, 1)), Math.abs(c) < .9999999 ? (this._x = Math.atan2(-u, h), this._y = Math.atan2(-d, o)) : (this._x = 0, this._y = Math.atan2(l, f));
                    break;
                case "XZY":
                    this._z = Math.asin(-i(s, -1, 1)), Math.abs(s) < .9999999 ? (this._x = Math.atan2(p, h), this._y = Math.atan2(l, o)) : (this._x = Math.atan2(-u, f), this._y = 0);
                    break;
                default:
        ...
        setFromQuaternion: function(e, t, n) {
            return ie.makeRotationFromQuaternion(e), this.setFromRotationMatrix(ie, t, n)
        },
    ...
    function ye() {
        Object.defineProperty(this, "id", {
            value: se++
        }), this.uuid = r.generateUUID(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = ye.DefaultUp.clone();
        var e = new m,
            t = new ae,
            n = new d,
            i = new m(1, 1, 1);
        ...
        }), this.matrix = new Y, this.matrixWorld = new Y, this.matrixAutoUpdate = ye.DefaultMatrixAutoUpdate, this.matrixWorldNeedsUpdate = !1, this.layers = new oe, this.visible = !0, this.castShadow = !1, this.receiveShadow = !1, this.frustumCulled = !0, this.renderOrder = 0, this.userData = {}
    }

    function Me() {
        ye.call(this), this.type = "Scene", this.background = null, this.environment = null, this.fog = null, this.overrideMaterial = null, this.autoUpdate = !0, "undefined" != typeof __THREE_DEVTOOLS__ && __THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe", {
            detail: this
        }))
    }
    ...
    function Se(e, t, n, i, r, a) {
        this.a = e, this.b = t, this.c = n, this.normal = i && i.isVector3 ? i : new m, this.vertexNormals = Array.isArray(i) ? i : [], this.color = r && r.isColor ? r : new Q, this.vertexColors = Array.isArray(r) ? r : [], this.materialIndex = void 0 !== a ? a : 0
    }
    ye.DefaultUp = new m(0, 1, 0), ye.DefaultMatrixAutoUpdate = !0, ye.prototype = Object.assign(Object.create(a.prototype), {
        constructor: ye,
        isObject3D: !0,
        ...
        rotateOnAxis: function(e, t) {
            return ce.setFromAxisAngle(e, t), this.quaternion.multiply(ce), this
        },
        rotateOnWorldAxis: function(e, t) {
            return ce.setFromAxisAngle(e, t), this.quaternion.premultiply(ce), this
        },
        rotateX: function(e) {
        ...
        lookAt: function(e, t, n) {
            ...
            var i = this.parent;
            this.updateWorldMatrix(!0, !1), de.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? he.lookAt(de, ue, this.up) : he.lookAt(ue, de, this.up), this.quaternion.setFromRotationMatrix(he), i && (he.extractRotation(i.matrixWorld), ce.setFromRotationMatrix(he), this.quaternion.premultiply(ce.inverse()))
        },
        add: function(e) {
            ...
            return e === this ? (console.error("THREE.Object3D.add: object can't be added as a child of itself.", e), this) : (e && e.isObject3D ? (null !== e.parent && e.parent.remove(e), e.parent = this, this.children.push(e), e.dispatchEvent(_e)) : console.error("THREE.Object3D.add: object not an instance of THREE.Object3D.", e), this)
        },
        remove: function(e) {
            if (arguments.length > 1) {
            ...
            return -1 !== n && (e.parent = null, this.children.splice(n, 1), e.dispatchEvent(xe)), this
        },
        attach: function(e) {
            return this.updateWorldMatrix(!0, !1), he.getInverse(this.matrixWorld), null !== e.parent && (e.parent.updateWorldMatrix(!0, !1), he.multiply(e.parent.matrixWorld)), e.applyMatrix4(he), e.updateWorldMatrix(!1, !1), this.add(e), this
        },
        ...
        getWorldPosition: function(e) {
            return void 0 === e && (console.warn("THREE.Object3D: .getWorldPosition() target is now required"), e = new m), this.updateMatrixWorld(!0), e.setFromMatrixPosition(this.matrixWorld)
        },
        getWorldQuaternion: function(e) {
            return void 0 === e && (console.warn("THREE.Object3D: .getWorldQuaternion() target is now required"), e = new d), this.updateMatrixWorld(!0), this.matrixWorld.decompose(de, e, pe), e
        },
        getWorldScale: function(e) {
            return void 0 === e && (console.warn("THREE.Object3D: .getWorldScale() target is now required"), e = new m), this.updateMatrixWorld(!0), this.matrixWorld.decompose(de, fe, e), e
        },
        getWorldDirection: function(e) {
            void 0 === e && (console.warn("THREE.Object3D: .getWorldDirection() target is now required"), e = new m), this.updateMatrixWorld(!0);
        ...
        toJSON: function(e) {
            ...
            if (void 0 !== this.material)
                if (Array.isArray(this.material)) {
                    var h = [];
                    for (s = 0, l = this.material.length; s < l; s++) h.push(r(e.materials, this.material[s]));
                    i.material = h
        ...
        isScene: !0,
        copy: function(e, t) {
            return ye.prototype.copy.call(this, e, t), null !== e.background && (this.background = e.background.clone()), null !== e.environment && (this.environment = e.environment.clone()), null !== e.fog && (this.fog = e.fog.clone()), null !== e.overrideMaterial && (this.overrideMaterial = e.overrideMaterial.clone()), this.autoUpdate = e.autoUpdate, this.matrixAutoUpdate = e.matrixAutoUpdate, this
        },
        toJSON: function(e) {
    ...
    function Re() {
        Object.defineProperty(this, "id", {
            value: we += 2
        }), this.uuid = r.generateUUID(), this.name = "", this.type = "Geometry", this.vertices = [], this.colors = [], this.faces = [], this.faceVertexUvs = [
            []
    ...
    Re.prototype = Object.assign(Object.create(a.prototype), {
        ...
        translate: function(e, t, n) {
            return Te.makeTranslation(e, t, n), this.applyMatrix4(Te), this
        },
        scale: function(e, t, n) {
            return Te.makeScale(e, t, n), this.applyMatrix4(Te), this
        },
        lookAt: function(e) {
            return Le.lookAt(e), Le.updateMatrix(), this.applyMatrix4(Le.matrix), this
        },
        fromBufferGeometry: function(e) {
            ...
            for (var h = 0; h < r.length; h += 3) t.vertices.push((new m).fromArray(r, h)), void 0 !== s && t.colors.push((new Q).fromArray(s, h));
            ...
            function u(e, n, i, r) {
                ...
                t.faces.push(u), void 0 !== l && t.faceVertexUvs[0].push([(new o).fromArray(l, 2 * e), (new o).fromArray(l, 2 * n), (new o).fromArray(l, 2 * i)]), void 0 !== c && t.faceVertexUvs[1].push([(new o).fromArray(c, 2 * e), (new o).fromArray(c, 2 * n), (new o).fromArray(c, 2 * i)])
            }
            var d = e.groups;
            if (d.length > 0)
                for (h = 0; h < d.length; h++)
                    for (var p = d[h], f = p.start, g = f, v = f + p.count; g < v; g += 3) void 0 !== n ? u(n[g], n[g + 1], n[g + 2], p.materialIndex) : u(g, g + 1, g + 2, p.materialIndex);
            else if (void 0 !== n)
        ...
        computeVertexNormals: function(e) {
            var t, n, i, r, a, o;
            for (void 0 === e && (e = !0), o = new Array(this.vertices.length), t = 0, n = this.vertices.length; t < n; t++) o[t] = new m;
            if (e) {
                var s, l, c, h = new m,
                    u = new m;
                for (i = 0, r = this.faces.length; i < r; i++) a = this.faces[i], s = this.vertices[a.a], l = this.vertices[a.b], c = this.vertices[a.c], h.subVectors(c, l), u.subVectors(s, l), h.cross(u), o[a.a].add(h), o[a.b].add(h), o[a.c].add(h)
            } else
        ...
        computeMorphNormals: function() {
            ...
            for (a.faces = this.faces, e = 0, t = this.morphTargets.length; e < t; e++) {
                if (!this.morphNormals[e]) {
                    ...
                    for (n = 0, i = this.faces.length; n < i; n++) l = new m, c = {
                        a: new m,
                        b: new m,
                        c: new m
                    }, o.push(l), s.push(c)
                ...
                for (a.vertices = this.morphTargets[e].vertices, a.computeFaceNormals(), a.computeVertexNormals(), n = 0, i = this.faces.length; n < i; n++) r = this.faces[n], l = h.faceNormals[n], c = h.vertexNormals[n], l.copy(r.normal), c.a.copy(r.vertexNormals[0]), c.b.copy(r.vertexNormals[1]), c.c.copy(r.vertexNormals[2])
            }
        ...
        computeBoundingSphere: function() {
            null === this.boundingSphere && (this.boundingSphere = new C), this.boundingSphere.setFromPoints(this.vertices)
        },
        merge: function(e, t, n) {
            if (e && e.isGeometry) {
                var i, r = this.vertices.length,
                    ...
                    h = this.colors,
                    u = e.colors;
                void 0 === n && (n = 0), void 0 !== t && (i = (new s).getNormalMatrix(t));
                ...
                for (d = 0, p = c.length; d < p; d++) {
                    var m, g, v, _ = c[d],
                        x = _.vertexNormals,
                        y = _.vertexColors;
                    (m = new Se(_.a + r, _.b + r, _.c + r)).normal.copy(_.normal), void 0 !== i && m.normal.applyMatrix3(i).normalize();
                    for (var M = 0, b = x.length; M < b; M++) g = x[M].clone(), void 0 !== i && g.applyMatrix3(i).normalize(), m.vertexNormals.push(g);
                    m.color.copy(_.color);
                    for (M = 0, b = y.length; M < b; M++) v = y[M], m.vertexColors.push(v.clone());
                ...
                for (d = 0, p = e.faceVertexUvs.length; d < p; d++) {
                    ...
                    for (M = 0, b = E.length; M < b; M++) {
                        for (var S = E[M], w = [], T = 0, L = S.length; T < L; T++) w.push(S[T].clone());
        ...
        mergeVertices: function() {
            var e, t, n, i, r, a, o, s, l = {},
                ...
                h = [],
                u = Math.pow(10, 4);
            for (n = 0, i = this.vertices.length; n < i; n++) e = this.vertices[n], void 0 === l[t = Math.round(e.x * u) + "_" + Math.round(e.y * u) + "_" + Math.round(e.z * u)] ? (l[t] = n, c.push(this.vertices[n]), h[n] = c.length - 1) : h[n] = h[l[t]];
            var d = [];
            for (n = 0, i = this.faces.length; n < i; n++) {
        ...
        toJSON: function() {
            ...
            for (r = 0; r < this.faces.length; r++) {
                var p = this.faces[r],
                    ...
                    x = 0;
                if (x = E(x, 0, 0), x = E(x, 1, !0), x = E(x, 2, !1), x = E(x, 3, f), x = E(x, 4, m), x = E(x, 5, g), x = E(x, 6, v), x = E(x, 7, _), o.push(x), o.push(p.a, p.b, p.c), o.push(p.materialIndex), f) {
            ...
            function w(e) {
                ...
                return void 0 !== h[t] || (h[t] = c.length, c.push(e.getHex())), h[t]
            }

            function T(e) {
                var t = e.x.toString() + e.y.toString();
                return void 0 !== d[t] || (d[t] = u.length / 2, u.push(e.x, e.y)), d[t]
            }
            return e.data = {}, e.data.vertices = i, e.data.normals = s, c.length > 0 && (e.data.colors = c), u.length > 0 && (e.data.uvs = [u]), e.data.faces = o, e
        },
        clone: function() {
        ...
        copy: function(e) {
                ...
                if (void 0 !== g[t].vertexNormals)
                    for (v.vertexNormals = [], i = 0, r = g[t].vertexNormals.length; i < r; i++) {
                        var _ = g[t].vertexNormals[i],
                            x = {};
                        x.a = _.a.clone(), x.b = _.b.clone(), x.c = _.c.clone(), v.vertexNormals.push(x)
                    }
            ...
            var y = e.skinWeights;
            for (t = 0, n = y.length; t < n; t++) this.skinWeights.push(y[t].clone());
            var M = e.skinIndices;
            for (t = 0, n = M.length; t < n; t++) this.skinIndices.push(M[t].clone());
    ...
    Object.defineProperty(De.prototype, "needsUpdate", {
        ...
        copyColorsArray: function(e) {
            for (var t = this.array, n = 0, i = 0, r = e.length; i < r; i++) {
                var a = e[i];
                void 0 === a && (console.warn("THREE.BufferAttribute.copyColorsArray(): color is undefined", i), a = new Q), t[n++] = a.r, t[n++] = a.g, t[n++] = a.b
            }
            return this
        },
        copyVector2sArray: function(e) {
            for (var t = this.array, n = 0, i = 0, r = e.length; i < r; i++) {
                var a = e[i];
                void 0 === a && (console.warn("THREE.BufferAttribute.copyVector2sArray(): vector is undefined", i), a = new o), t[n++] = a.x, t[n++] = a.y
            }
            return this
        },
        copyVector3sArray: function(e) {
            for (var t = this.array, n = 0, i = 0, r = e.length; i < r; i++) {
                var a = e[i];
                void 0 === a && (console.warn("THREE.BufferAttribute.copyVector3sArray(): vector is undefined", i), a = new m), t[n++] = a.x, t[n++] = a.y, t[n++] = a.z
            }
            return this
        },
        copyVector4sArray: function(e) {
            for (var t = this.array, n = 0, i = 0, r = e.length; i < r; i++) {
                var a = e[i];
                void 0 === a && (console.warn("THREE.BufferAttribute.copyVector4sArray(): vector is undefined", i), a = new ne), t[n++] = a.x, t[n++] = a.y, t[n++] = a.z, t[n++] = a.w
            }
            return this
        },
        applyMatrix3: function(e) {
            for (var t = 0, n = this.count; t < n; t++) Pe.x = this.getX(t), Pe.y = this.getY(t), Pe.z = this.getZ(t), Pe.applyMatrix3(e), this.setXYZ(t, Pe.x, Pe.y, Pe.z);
            return this
        },
        applyMatrix4: function(e) {
            for (var t = 0, n = this.count; t < n; t++) Pe.x = this.getX(t), Pe.y = this.getY(t), Pe.z = this.getZ(t), Pe.applyMatrix4(e), this.setXYZ(t, Pe.x, Pe.y, Pe.z);
            return this
        },
        applyNormalMatrix: function(e) {
            for (var t = 0, n = this.count; t < n; t++) Pe.x = this.getX(t), Pe.y = this.getY(t), Pe.z = this.getZ(t), Pe.applyNormalMatrix(e), this.setXYZ(t, Pe.x, Pe.y, Pe.z);
            return this
        },
        transformDirection: function(e) {
            for (var t = 0, n = this.count; t < n; t++) Pe.x = this.getX(t), Pe.y = this.getY(t), Pe.z = this.getZ(t), Pe.transformDirection(e), this.setXYZ(t, Pe.x, Pe.y, Pe.z);
            return this
        },
        set: function(e, t) {
    ...
    }), Ce.prototype = Object.create(De.prototype), Ce.prototype.constructor = Ce, Ne.prototype = Object.create(De.prototype), Ne.prototype.constructor = Ne, Ue.prototype = Object.create(De.prototype), Ue.prototype.constructor = Ue, Ie.prototype = Object.create(De.prototype), Ie.prototype.constructor = Ie, Fe.prototype = Object.create(De.prototype), Fe.prototype.constructor = Fe, Oe.prototype = Object.create(De.prototype), Oe.prototype.constructor = Oe, ze.prototype = Object.create(De.prototype), ze.prototype.constructor = ze, Be.prototype = Object.create(De.prototype), Be.prototype.constructor = Be, Ge.prototype = Object.create(De.prototype), Ge.prototype.constructor = Ge, Object.assign(He.prototype, {
        ...
        fromGeometry: function(e) {
            ...
            for (h = 0; h < n.length; h++) {
                ...
                if (!0 === a) void 0 !== (M = r[0][h]) ? this.uvs.push(M[0], M[1], M[2]) : (console.warn("THREE.DirectGeometry.fromGeometry(): Undefined vertexUv ", h), this.uvs.push(new o, new o, new o));
                if (!0 === s) void 0 !== (M = r[1][h]) ? this.uvs2.push(M[0], M[1], M[2]) : (console.warn("THREE.DirectGeometry.fromGeometry(): Undefined vertexUv2 ", h), this.uvs2.push(new o, new o, new o));
                for (var S = 0; S < c; S++) {
                    var w = l[S].vertices;
    ...
    function Je() {
        Object.defineProperty(this, "id", {
            value: ke += 2
        }), this.uuid = r.generateUUID(), this.name = "", this.type = "BufferGeometry", this.index = null, this.attributes = {}, this.morphAttributes = {}, this.morphTargetsRelative = !1, this.groups = [], this.boundingBox = null, this.boundingSphere = null, this.drawRange = {
            start: 0,
            count: 1 / 0
        }, this.userData = {}
    }
    Je.prototype = Object.assign(Object.create(a.prototype), {
        ...
        rotateX: function(e) {
            return We.makeRotationX(e), this.applyMatrix4(We), this
        },
        rotateY: function(e) {
            return We.makeRotationY(e), this.applyMatrix4(We), this
        },
        rotateZ: function(e) {
            return We.makeRotationZ(e), this.applyMatrix4(We), this
        },
        translate: function(e, t, n) {
            return We.makeTranslation(e, t, n), this.applyMatrix4(We), this
        },
        scale: function(e, t, n) {
            return We.makeScale(e, t, n), this.applyMatrix4(We), this
        },
        lookAt: function(e) {
            return Xe.lookAt(e), Xe.updateMatrix(), this.applyMatrix4(Xe.matrix), this
        },
        center: function() {
        ...
        fromGeometry: function(e) {
            return e.__directGeometry = (new He).fromGeometry(e), this.fromDirectGeometry(e.__directGeometry)
        },
        fromDirectGeometry: function(e) {
            var t = new Float32Array(3 * e.vertices.length);
            if (this.setAttribute("position", new De(t, 3).copyVector3sArray(e.vertices)), e.normals.length > 0) {
            ...
            if (void 0 !== e) {
                if (this.boundingBox.setFromBufferAttribute(e), t)
                    for (var n = 0, i = t.length; n < i; n++) {
                        var r = t[n];
                        Ye.setFromBufferAttribute(r), this.morphTargetsRelative ? (Ze.addVectors(this.boundingBox.min, Ye.min), this.boundingBox.expandByPoint(Ze), Ze.addVectors(this.boundingBox.max, Ye.max), this.boundingBox.expandByPoint(Ze)) : (this.boundingBox.expandByPoint(Ye.min), this.boundingBox.expandByPoint(Ye.max))
                    }
        ...
        computeBoundingSphere: function() {
            ...
            if (e) {
                ...
                if (Ye.setFromBufferAttribute(e), t)
                    for (var i = 0, r = t.length; i < r; i++) {
                        var a = t[i];
                        qe.setFromBufferAttribute(a), this.morphTargetsRelative ? (Ze.addVectors(Ye.min, qe.min), Ye.expandByPoint(Ze), Ze.addVectors(Ye.max, qe.max), Ye.expandByPoint(Ze)) : (Ye.expandByPoint(qe.min), Ye.expandByPoint(qe.max))
                    }
                Ye.getCenter(n);
                var o = 0;
                for (i = 0, r = e.count; i < r; i++) Ze.fromBufferAttribute(e, i), o = Math.max(o, n.distanceToSquared(Ze));
                if (t)
                    for (i = 0, r = t.length; i < r; i++) {
                        a = t[i];
                        for (var s = this.morphTargetsRelative, l = 0, c = a.count; l < c; l++) Ze.fromBufferAttribute(a, l), s && (je.fromBufferAttribute(e, l), Ze.add(je)), o = Math.max(o, n.distanceToSquared(Ze))
                    }
        ...
        computeVertexNormals: function() {
            ...
            if (t.position) {
                ...
                if (void 0 === t.normal) this.setAttribute("normal", new De(new Float32Array(n.length), 3));
                else
                ...
                if (e) {
                    var g = e.array;
                    for (r = 0, a = e.count; r < a; r += 3) o = 3 * g[r + 0], s = 3 * g[r + 1], l = 3 * g[r + 2], h.fromArray(n, o), u.fromArray(n, s), d.fromArray(n, l), p.subVectors(d, u), f.subVectors(h, u), p.cross(f), c[o] += p.x, c[o + 1] += p.y, c[o + 2] += p.z, c[s] += p.x, c[s + 1] += p.y, c[s + 2] += p.z, c[l] += p.x, c[l + 1] += p.y, c[l + 2] += p.z
                } else
                    for (r = 0, a = n.length; r < a; r += 9) h.fromArray(n, r), u.fromArray(n, r + 3), d.fromArray(n, r + 6), p.subVectors(d, u), f.subVectors(h, u), p.cross(f), c[r] = p.x, c[r + 1] = p.y, c[r + 2] = p.z, c[r + 3] = p.x, c[r + 4] = p.y, c[r + 5] = p.z, c[r + 6] = p.x, c[r + 7] = p.y, c[r + 8] = p.z;
            ...
            if (e && e.isBufferGeometry) {
                ...
                for (var i in n)
                    if (void 0 !== e.attributes[i])
                        for (var r = n[i].array, a = e.attributes[i], o = a.array, s = a.itemSize * t, l = Math.min(o.length, r.length - s), c = 0, h = s; c < l; c++, h++) r[h] = o[c];
                return this
            }
            console.error("THREE.BufferGeometry.merge(): geometry not an instance of THREE.BufferGeometry.", e)
        },
        normalizeNormals: function() {
            for (var e = this.attributes.normal, t = 0, n = e.count; t < n; t++) Ze.x = e.getX(t), Ze.y = e.getY(t), Ze.z = e.getZ(t), Ze.normalize(), e.setXYZ(t, Ze.x, Ze.y, Ze.z)
        },
        ...
        constructor(e, t, n, i, r, a) {
            ...
            function p(e, t, n, i, r, a, p, f, g, v, _) {
                ...
                for (y = 0; y < L; y++) {
                    ...
                    for (x = 0; x < T; x++) {
                        var C = x * M - E;
                        P[e] = C * i, P[t] = D * r, P[n] = w, l.push(P.x, P.y, P.z), P[e] = 0, P[t] = 0, P[n] = f > 0 ? 1 : -1, c.push(P.x, P.y, P.z), h.push(x / g), h.push(1 - y / v), A += 1
                    }
                }
                for (y = 0; y < v; y++)
                    for (x = 0; x < g; x++) {
                        var N = u + x + T * y,
                            ...
                            I = u + (x + 1) + T * (y + 1),
                            F = u + (x + 1) + T * y;
                        s.push(N, U, F), s.push(U, I, F), R += 6
                    }
                o.addGroup(d, R, _), d += R, u += A
            }
            p("z", "y", "x", -1, -1, n, t, e, a, r, 0), p("z", "y", "x", 1, -1, n, t, -e, a, r, 1), p("x", "z", "y", 1, 1, e, n, t, i, a, 2), p("x", "z", "y", 1, -1, e, n, -t, i, a, 3), p("x", "y", "z", 1, -1, e, t, n, i, r, 4), p("x", "y", "z", -1, -1, e, t, -n, i, r, 5), this.setIndex(s), this.setAttribute("position", new Be(l, 3)), this.setAttribute("normal", new Be(c, 3)), this.setAttribute("uv", new Be(h, 2))
        }
    }

    function Ke(e, t, n, i) {
        Re.call(this), this.type = "PlaneGeometry", this.parameters = {
            width: e,
            height: t,
            widthSegments: n,
            heightSegments: i
        }, this.fromBufferGeometry(new $e(e, t, n, i)), this.mergeVertices()
    }
        ...
        for (a = 0; a < c; a++)
            for (r = 0; r < l; r++) {
                var y = r + h * a,
                    ...
                    b = r + 1 + h * (a + 1),
                    E = r + 1 + h * a;
                f.push(y, M, E), f.push(M, b, E)
            }
        this.setIndex(f), this.setAttribute("position", new Be(m, 3)), this.setAttribute("normal", new Be(g, 3)), this.setAttribute("uv", new Be(v, 2))
    }
    Ke.prototype = Object.create(Re.prototype), Ke.prototype.constructor = Ke, $e.prototype = Object.create(Je.prototype), $e.prototype.constructor = $e;
    var et = 0;

    function tt() {
        Object.defineProperty(this, "id", {
            value: et++
        }), this.uuid = r.generateUUID(), this.name = "", this.type = "Material", this.fog = !0, this.blending = 1, this.side = 0, this.flatShading = !1, this.vertexColors = !1, this.opacity = 1, this.transparent = !1, this.blendSrc = 204, this.blendDst = 205, this.blendEquation = 100, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.depthFunc = 3, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = 519, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = 7680, this.stencilZFail = 7680, this.stencilZPass = 7680, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaTest = 0, this.premultipliedAlpha = !1, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0
    }
    ...
    function at(e) {
        tt.call(this), this.type = "ShaderMaterial", this.defines = {}, this.uniforms = {}, this.vertexShader = "\nvoid main() {\n\tgl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );\n}\n", this.fragmentShader = "\nvoid main() {\n\tgl_FragColor = vec4( 1.0, 0.0, 0.0, 1.0 );\n}\n", this.linewidth = 1, this.wireframe = !1, this.wireframeLinewidth = 1, this.fog = !1, this.lights = !1, this.clipping = !1, this.skinning = !1, this.morphTargets = !1, this.morphNormals = !1, this.extensions = {
            derivatives: !1,
            fragDepth: !1,
            drawBuffers: !1,
            shaderTextureLOD: !1
    ...
    at.prototype = Object.create(tt.prototype), at.prototype.constructor = at, at.prototype.isShaderMaterial = !0, at.prototype.copy = function(e) {
        return tt.prototype.copy.call(this, e), this.fragmentShader = e.fragmentShader, this.vertexShader = e.vertexShader, this.uniforms = nt(e.uniforms), this.defines = Object.assign({}, e.defines), this.wireframe = e.wireframe, this.wireframeLinewidth = e.wireframeLinewidth, this.lights = e.lights, this.clipping = e.clipping, this.skinning = e.skinning, this.morphTargets = e.morphTargets, this.morphNormals = e.morphNormals, this.extensions = e.extensions, this
    ...
    function pt(e, t) {
        this.origin = void 0 !== e ? e : new m, this.direction = void 0 !== t ? t : new m(0, 0, -1)
    }
    Object.assign(pt.prototype, {
        ...
        at: function(e, t) {
            return void 0 === t && (console.warn("THREE.Ray: .at() target is now required"), t = new m), t.copy(this.direction).multiplyScalar(e).add(this.origin)
        },
        lookAt: function(e) {
        ...
        closestPointToPoint: function(e, t) {
            void 0 === t && (console.warn("THREE.Ray: .closestPointToPoint() target is now required"), t = new m), t.subVectors(e, this.origin);
        ...
        distanceSqToPoint: function(e) {
            ...
            return t < 0 ? this.origin.distanceToSquared(e) : (ot.copy(this.direction).multiplyScalar(t).add(this.origin), ot.distanceToSquared(e))
        },
        distanceSqToSegment: function(e, t, n, i) {
            st.copy(e).add(t).multiplyScalar(.5), lt.copy(t).sub(e).normalize(), ct.copy(this.origin).sub(st);
            var r, a, o, s, l = .5 * e.distanceTo(t),
                c = -this.direction.dot(lt),
                h = ct.dot(this.direction),
                u = -ct.dot(lt),
                d = ct.lengthSq(),
                p = Math.abs(1 - c * c);
            if (p > 0)
                if (a = c * h - u, s = l * p, (r = c * u - h) >= 0)
                    if (a >= -s)
                        if (a <= s) {
                            var f = 1 / p;
            ...
            else a <= -s ? o = -(r = Math.max(0, -(-c * l + h))) * r + (a = r > 0 ? -l : Math.min(Math.max(-l, -u), l)) * (a + 2 * u) + d : a <= s ? (r = 0, o = (a = Math.min(Math.max(-l, -u), l)) * (a + 2 * u) + d) : o = -(r = Math.max(0, -(c * l + h))) * r + (a = r > 0 ? l : Math.min(Math.max(-l, -u), l)) * (a + 2 * u) + d;
            else a = c > 0 ? -l : l, o = -(r = Math.max(0, -(c * a + h))) * r + a * (a + 2 * u) + d;
            return n && n.copy(this.direction).multiplyScalar(r).add(this.origin), i && i.copy(lt).multiplyScalar(a).add(st), o
        },
        ...
        intersectBox: function(e, t) {
            var n, i, r, a, o, s, l = 1 / this.direction.x,
                ...
                u = this.origin;
            return l >= 0 ? (n = (e.min.x - u.x) * l, i = (e.max.x - u.x) * l) : (n = (e.max.x - u.x) * l, i = (e.min.x - u.x) * l), c >= 0 ? (r = (e.min.y - u.y) * c, a = (e.max.y - u.y) * c) : (r = (e.max.y - u.y) * c, a = (e.min.y - u.y) * c), n > a || r > i ? null : ((r > n || n != n) && (n = r), (a < i || i != i) && (i = a), h >= 0 ? (o = (e.min.z - u.z) * h, s = (e.max.z - u.z) * h) : (o = (e.max.z - u.z) * h, s = (e.min.z - u.z) * h), n > s || o > i ? null : ((o > n || n != n) && (n = o), (s < i || i != i) && (i = s), i < 0 ? null : this.at(n >= 0 ? n : i, t)))
        },
        intersectsBox: function(e) {
            return null !== this.intersectBox(e, ot)
        },
        intersectTriangle: function(e, t, n, i, r) {
            ht.subVectors(t, e), ut.subVectors(n, e), dt.crossVectors(ht, ut);
    ...
    function St(e, t, n) {
        this.a = void 0 !== e ? e : new m, this.b = void 0 !== t ? t : new m, this.c = void 0 !== n ? n : new m
    }
    ...
    Object.assign(St, {
        getNormal: function(e, t, n, i) {
            void 0 === i && (console.warn("THREE.Triangle: .getNormal() target is now required"), i = new m), i.subVectors(n, t), ft.subVectors(e, t), i.cross(ft);
            var r = i.lengthSq();
            return r > 0 ? i.multiplyScalar(1 / Math.sqrt(r)) : i.set(0, 0, 0)
        },
        getBarycoord: function(e, t, n, i, r) {
            ft.subVectors(i, t), mt.subVectors(n, t), gt.subVectors(e, t);
            var a = ft.dot(ft),
                o = ft.dot(mt),
                s = ft.dot(gt),
                l = mt.dot(mt),
                c = mt.dot(gt),
                h = a * l - o * o;
            if (void 0 === r && (console.warn("THREE.Triangle: .getBarycoord() target is now required"), r = new m), 0 === h) return r.set(-2, -1, -1);
            var u = 1 / h,
                d = (l * s - o * c) * u,
                p = (a * c - o * s) * u;
        ...
        containsPoint: function(e, t, n, i) {
            return St.getBarycoord(e, t, n, i, vt), vt.x >= 0 && vt.y >= 0 && vt.x + vt.y <= 1
        },
        getUV: function(e, t, n, i, r, a, o, s) {
            return this.getBarycoord(e, t, n, i, vt), s.set(0, 0), s.addScaledVector(r, vt.x), s.addScaledVector(a, vt.y), s.addScaledVector(o, vt.z), s
        },
        isFrontFacing: function(e, t, n, i) {
            return ft.subVectors(n, t), mt.subVectors(e, t), ft.cross(mt).dot(i) < 0
        }
        ...
        getArea: function() {
            return ft.subVectors(this.c, this.b), mt.subVectors(this.a, this.b), .5 * ft.cross(mt).length()
        },
        getMidpoint: function(e) {
            return void 0 === e && (console.warn("THREE.Triangle: .getMidpoint() target is now required"), e = new m), e.addVectors(this.a, this.b).add(this.c).multiplyScalar(1 / 3)
        },
        getNormal: function(e) {
            return St.getNormal(this.a, this.b, this.c, e)
        },
        getPlane: function(e) {
            return void 0 === e && (console.warn("THREE.Triangle: .getPlane() target is now required"), e = new F), e.setFromCoplanarPoints(this.a, this.b, this.c)
        },
        ...
        closestPointToPoint: function(e, t) {
            void 0 === t && (console.warn("THREE.Triangle: .closestPointToPoint() target is now required"), t = new m);
            var n, i, r = this.a,
                a = this.b,
                o = this.c;
            _t.subVectors(a, r), xt.subVectors(o, r), Mt.subVectors(e, r);
            var s = _t.dot(Mt),
                l = xt.dot(Mt);
            ...
            var c = _t.dot(bt),
                h = xt.dot(bt);
            if (c >= 0 && h <= c) return t.copy(a);
            var u = s * h - c * l;
            if (u <= 0 && s >= 0 && c <= 0) return n = s / (s - c), t.copy(r).addScaledVector(_t, n);
            Et.subVectors(e, o);
            var d = _t.dot(Et),
                p = xt.dot(Et);
            if (p >= 0 && d <= p) return t.copy(o);
            var f = d * l - s * p;
            if (f <= 0 && l >= 0 && p <= 0) return i = l / (l - p), t.copy(r).addScaledVector(xt, i);
            var g = c * p - d * h;
            if (g <= 0 && h - c >= 0 && d - p >= 0) return yt.subVectors(o, a), i = (h - c) / (h - c + (d - p)), t.copy(a).addScaledVector(yt, i);
            var v = 1 / (g + f + u);
            return n = f * v, i = u * v, t.copy(r).addScaledVector(_t, n).addScaledVector(xt, i)
        },
        equals: function(e) {
            return e.a.equals(this.a) && e.b.equals(this.b) && e.c.equals(this.c)
        }
    }), wt.prototype = Object.create(tt.prototype), wt.prototype.constructor = wt, wt.prototype.isMeshBasicMaterial = !0, wt.prototype.copy = function(e) {
        return tt.prototype.copy.call(this, e), this.color.copy(e.color), this.map = e.map, this.lightMap = e.lightMap, this.lightMapIntensity = e.lightMapIntensity, this.aoMap = e.aoMap, this.aoMapIntensity = e.aoMapIntensity, this.specularMap = e.specularMap, this.alphaMap = e.alphaMap, this.envMap = e.envMap, this.combine = e.combine, this.reflectivity = e.reflectivity, this.refractionRatio = e.refractionRatio, this.wireframe = e.wireframe, this.wireframeLinewidth = e.wireframeLinewidth, this.wireframeLinecap = e.wireframeLinecap, this.wireframeLinejoin = e.wireframeLinejoin, this.skinning = e.skinning, this.morphTargets = e.morphTargets, this
    };
    var Tt = new Y,
        Lt = new pt,
        At = new C,
    ...
    function kt(e, t) {
        ye.call(this), this.type = "Mesh", this.geometry = void 0 !== e ? e : new Je, this.material = void 0 !== t ? t : new wt, this.updateMorphTargets()
    }
    ...
    function Wt(e, t, n, i, r, a, o, s) {
        ...
        Vt.copy(s), Vt.applyMatrix4(e.matrixWorld);
    ...
    function Xt(e, t, n, i, r, a, s, l, c, h, u, d) {
        Rt.fromBufferAttribute(r, h), Pt.fromBufferAttribute(r, u), Dt.fromBufferAttribute(r, d);
        var p = e.morphTargetInfluences;
        if (t.morphTargets && a && p) {
            It.set(0, 0, 0), Ft.set(0, 0, 0), Ot.set(0, 0, 0);
            for (var f = 0, m = a.length; f < m; f++) {
                var g = p[f],
                    v = a[f];
                0 !== g && (Ct.fromBufferAttribute(v, h), Nt.fromBufferAttribute(v, u), Ut.fromBufferAttribute(v, d), s ? (It.addScaledVector(Ct, g), Ft.addScaledVector(Nt, g), Ot.addScaledVector(Ut, g)) : (It.addScaledVector(Ct.sub(Rt), g), Ft.addScaledVector(Nt.sub(Pt), g), Ot.addScaledVector(Ut.sub(Dt), g)))
            }
            Rt.add(It), Pt.add(Ft), Dt.add(Ot)
        }
        e.isSkinnedMesh && (e.boneTransform(h, Rt), e.boneTransform(u, Pt), e.boneTransform(d, Dt));
        var _ = Wt(e, t, n, i, Rt, Pt, Dt, Ht);
        if (_) {
            l && (zt.fromBufferAttribute(l, h), Bt.fromBufferAttribute(l, u), Gt.fromBufferAttribute(l, d), _.uv = St.getUV(Ht, Rt, Pt, Dt, zt, Bt, Gt, new o)), c && (zt.fromBufferAttribute(c, h), Bt.fromBufferAttribute(c, u), Gt.fromBufferAttribute(c, d), _.uv2 = St.getUV(Ht, Rt, Pt, Dt, zt, Bt, Gt, new o));
            var x = new Se(h, u, d);
            St.getNormal(Rt, Pt, Dt, x.normal), _.face = x
        }
        return _
    }
    kt.prototype = Object.assign(Object.create(ye.prototype), {
        ...
        isMesh: !0,
        copy: function(e) {
            return ye.prototype.copy.call(this, e), void 0 !== e.morphTargetInfluences && (this.morphTargetInfluences = e.morphTargetInfluences.slice()), void 0 !== e.morphTargetDictionary && (this.morphTargetDictionary = Object.assign({}, e.morphTargetDictionary)), this
        },
        ...
        raycast: function(e, t) {
            var n, i = this.geometry,
                r = this.material,
                a = this.matrixWorld;
            if (void 0 !== r && (null === i.boundingSphere && i.computeBoundingSphere(), At.copy(i.boundingSphere), At.applyMatrix4(a), !1 !== e.ray.intersectsSphere(At) && (Tt.getInverse(a), Lt.copy(e.ray).applyMatrix4(Tt), null === i.boundingBox || !1 !== Lt.intersectsBox(i.boundingBox))))
                if (i.isBufferGeometry) {
                    var s, l, c, h, u, d, p, f, m, g = i.index,
                    ...
                    if (null !== g)
                        if (Array.isArray(r))
                            for (h = 0, d = b.length; h < d; h++)
                                for (m = r[(f = b[h]).materialIndex], u = Math.max(f.start, E.start), p = Math.min(f.start + f.count, E.start + E.count); u < p; u += 3) s = g.getX(u), l = g.getX(u + 1), c = g.getX(u + 2), (n = Xt(this, m, e, Lt, v, _, x, y, M, s, l, c)) && (n.faceIndex = Math.floor(u / 3), n.face.materialIndex = f.materialIndex, t.push(n));
                        else
                            for (h = Math.max(0, E.start), d = Math.min(g.count, E.start + E.count); h < d; h += 3) s = g.getX(h), l = g.getX(h + 1), c = g.getX(h + 2), (n = Xt(this, r, e, Lt, v, _, x, y, M, s, l, c)) && (n.faceIndex = Math.floor(h / 3), t.push(n));
                    else if (void 0 !== v)
                        if (Array.isArray(r))
                            for (h = 0, d = b.length; h < d; h++)
                                for (m = r[(f = b[h]).materialIndex], u = Math.max(f.start, E.start), p = Math.min(f.start + f.count, E.start + E.count); u < p; u += 3)(n = Xt(this, m, e, Lt, v, _, x, y, M, s = u, l = u + 1, c = u + 2)) && (n.faceIndex = Math.floor(u / 3), n.face.materialIndex = f.materialIndex, t.push(n));
                        else
                            for (h = Math.max(0, E.start), d = Math.min(v.count, E.start + E.count); h < d; h += 3)(n = Xt(this, r, e, Lt, v, _, x, y, M, s = h, l = h + 1, c = h + 2)) && (n.faceIndex = Math.floor(h / 3), t.push(n))
                } else if (i.isGeometry) {
                var S, w, T, L, A = Array.isArray(r),
                    R = i.vertices,
                    P = i.faces,
                    D = i.faceVertexUvs[0];
                D.length > 0 && (L = D);
                for (var C = 0, N = P.length; C < N; C++) {
                    ...
                    if (void 0 !== I && (S = R[U.a], w = R[U.b], T = R[U.c], n = Wt(this, I, e, Lt, S, w, T, Ht))) {
                        if (L && L[C]) {
                            var F = L[C];
                            zt.copy(F[0]), Bt.copy(F[1]), Gt.copy(F[2]), n.uv = St.getUV(Ht, S, w, T, zt, Bt, Gt, new o)
                        }
                        n.face = U, n.faceIndex = C, t.push(n)
                    }
                }
            }
        },
    ...
    function qt(e, t, n, i) {
        ...
        return {
            ...
            render: function(t, i, d, p) {
                ...
                if (g && "additive" === g.environmentBlendMode && (f = null), null === f ? u(o, s) : f && f.isColor && (u(f, 1), p = !0), (e.autoClear || p) && e.clear(e.autoClearColor, e.autoClearDepth, e.autoClearStencil), f && (f.isCubeTexture || f.isWebGLCubeRenderTarget || 306 === f.mapping)) {
                    ...
                    a.material.uniforms.envMap.value = v, a.material.uniforms.flipEnvMap.value = v.isCubeTexture ? -1 : 1, l === f && c === v.version && h === e.toneMapping || (a.material.needsUpdate = !0, l = f, c = v.version, h = e.toneMapping), t.unshift(a, a.geometry, a.material, 0, 0, null)
                } else f && f.isTexture && (void 0 === r && ((r = new kt(new $e(2, 2), new at({
                ...
                }), n.update(r)), r.material.uniforms.t2D.value = f, !0 === f.matrixAutoUpdate && f.updateMatrix(), r.material.uniforms.uvTransform.value.copy(f.matrix), l === f && c === f.version && h === e.toneMapping || (r.material.needsUpdate = !0, l = f, c = f.version, h = e.toneMapping), t.unshift(r, r.geometry, r.material, 0, 0, null))
            }
        }
    }
    ...
    function Zt(e, t, n, i) {
        ...
        this.setMode = function(e) {
            ...
            if (0 !== l) {
                var c, h;
                if (a) c = e, h = "drawArraysInstanced";
                else if (h = "drawArraysInstancedANGLE", null === (c = t.get("ANGLE_instanced_arrays"))) return void console.error("THREE.WebGLBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");
                c[h](r, o, s, l), n.update(s, r, l)
            }
        }
    }
        ...
        function h(t, n, i, r) {
            ...
            if (0 !== s) {
                if (c = l.value, !0 !== r || null === c) {
                    ...
                    o.getNormalMatrix(u), (null === c || c.length < h) && (c = new Float32Array(h));
                    for (var d = 0, p = i; d !== s; ++d, p += 4) a.copy(t[d]).applyMatrix4(u, o), a.normal.toArray(c, p), c[p + 3] = a.constant
                }
                l.value = c, l.needsUpdate = !0
            }
            return e.numPlanes = s, e.numIntersection = 0, c
        }
        this.uniform = l, this.numPlanes = 0, this.numIntersection = 0, this.init = function(e, r, a) {
    ...
    function $t(e, t, n) {
        ...
        function o(n) {
            ...
            f.version = s, t.update(f, e.ELEMENT_ARRAY_BUFFER);
            var m = r.get(n);
            m && t.remove(m), r.set(n, f)
        }
        return {
            get: function(e, t) {
                var r = i.get(t);
                return r || (t.addEventListener("dispose", a), t.isBufferGeometry ? r = t : t.isGeometry && (void 0 === t._bufferGeometry && (t._bufferGeometry = (new Je).setFromObject(e)), r = t._bufferGeometry), i.set(t, r), n.memory.geometries++, r)
            },
            update: function(n) {
                var i = n.index,
                    r = n.attributes;
                ...
                for (var a in o)
                    for (var s = o[a], l = 0, c = s.length; l < c; l++) t.update(s[l], e.ARRAY_BUFFER)
            },
    ...
    function en(e, t, n, i) {
        ...
        this.setMode = function(e) {
            ...
            if (0 !== h) {
                var u, d;
                if (s) u = e, d = "drawElementsInstanced";
                else if (d = "drawElementsInstancedANGLE", null === (u = t.get("ANGLE_instanced_arrays"))) return void console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");
                u[d](r, c, a, l * o, h), n.update(c, r, h)
            }
        }
    }
    ...
    function rn(e) {
        ...
        return {
            update: function(i, r, a, o) {
                ...
                for (h = 0; h < 8; h++) {
                    ...
                    if (f = c[h]) {
                        var m = f[0],
                            g = f[1];
                        if (g) {
                            u && r.setAttribute("morphTarget" + h, u[m]), d && r.setAttribute("morphNormal" + h, d[m]), n[h] = g, p += g;
                            continue
                        }
                    }
                    n[h] = 0
                ...
                o.getUniforms().setValue(e, "morphTargetBaseInfluence", v), o.getUniforms().setValue(e, "morphTargetInfluences", n)
            }
        }
    }
        ...
        return {
            update: function(a) {
                var o = i.render.frame,
                    s = a.geometry,
                    l = t.get(a, s);
                return r.get(l) !== o && (s.isGeometry && l.updateFromObject(a), t.update(l), r.set(l, o)), a.isInstancedMesh && n.update(a.instanceMatrix, e.ARRAY_BUFFER), l
            },
            dispose: function() {
                r = new WeakMap
            }
    ...
    function on(e, t, n, i, r, a, o, s, l, c) {
        e = void 0 !== e ? e : [], t = void 0 !== t ? t : 301, o = void 0 !== o ? o : 1022, h.call(this, e, t, n, i, r, a, o, s, l, c), this.flipY = !1
    }

    function sn(e, t, n, i) {
        h.call(this, null), this.image = {
            data: e || null,
            width: t || 1,
            height: n || 1,
            depth: i || 1
    ...
    Yt.physical = {
        ...
        vertexShader: jt.meshphysical_vert,
        fragmentShader: jt.meshphysical_frag
    }, on.prototype = Object.create(h.prototype), on.prototype.constructor = on, on.prototype.isCubeTexture = !0, Object.defineProperty(on.prototype, "images", {
        get: function() {
            return this.image
        },
        set: function(e) {
    ...
    }), sn.prototype = Object.create(h.prototype), sn.prototype.constructor = sn, sn.prototype.isDataTexture2DArray = !0, ln.prototype = Object.create(h.prototype), ln.prototype.constructor = ln, ln.prototype.isDataTexture3D = !0;
    var cn = new h,
        hn = new sn,
        un = new ln,
        dn = new on,
    ...
    function _n(e, t, n) {
        ...
        var r = t * n,
            a = pn[r];
        if (void 0 === a && (a = new Float32Array(r), pn[r] = a), 0 !== t) {
            i.toArray(a, 0);
    ...
    function Mn(e, t) {
        var n = fn[t];
        void 0 === n && (n = new Int32Array(t), fn[t] = n);
    ...
    function Tn(e, t) {
        ...
        if (void 0 === i) {
            ...
            if (xn(n, i)) return;
            vn.set(i), e.uniformMatrix2fv(this.addr, !1, vn), yn(n, i)
        }
    }
    ...
    function Ln(e, t) {
        ...
        if (void 0 === i) {
            ...
            if (xn(n, i)) return;
            gn.set(i), e.uniformMatrix3fv(this.addr, !1, gn), yn(n, i)
        }
    }
    ...
    function An(e, t) {
        ...
        if (void 0 === i) {
            ...
            if (xn(n, i)) return;
            mn.set(i), e.uniformMatrix4fv(this.addr, !1, mn), yn(n, i)
        }
    }
    ...
    function Rn(e, t, n) {
        ...
        i[0] !== r && (e.uniform1i(this.addr, r), i[0] = r), n.safeSetTexture2D(t || cn, r)
    }

    function Pn(e, t, n) {
        var i = this.cache,
            r = n.allocateTextureUnit();
        i[0] !== r && (e.uniform1i(this.addr, r), i[0] = r), n.setTexture2DArray(t || hn, r)
    }

    function Dn(e, t, n) {
        var i = this.cache,
            r = n.allocateTextureUnit();
        i[0] !== r && (e.uniform1i(this.addr, r), i[0] = r), n.setTexture3D(t || un, r)
    }

    function Cn(e, t, n) {
        var i = this.cache,
            r = n.allocateTextureUnit();
        i[0] !== r && (e.uniform1i(this.addr, r), i[0] = r), n.safeSetTextureCube(t || dn, r)
    }
    ...
    function Un(e, t) {
        var n = this.cache;
        xn(n, t) || (e.uniform2iv(this.addr, t), yn(n, t))
    }

    function In(e, t) {
        var n = this.cache;
        xn(n, t) || (e.uniform3iv(this.addr, t), yn(n, t))
    }

    function Fn(e, t) {
        var n = this.cache;
        xn(n, t) || (e.uniform4iv(this.addr, t), yn(n, t))
    }
    ...
    function Zn(e, t, n) {
        ...
        for (var a = 0; a !== i; ++a) n.safeSetTexture2D(t[a] || cn, r[a])
    }
    ...
    function Jn(e, t, n) {
        var i = t.length,
            r = Mn(n, i);
        e.uniform1iv(this.addr, r);
        for (var a = 0; a !== i; ++a) n.safeSetTextureCube(t[a] || dn, r[a])
    }
    ...
    Kn.prototype.updateCache = function(e) {
        var t = this.cache;
        e instanceof Float32Array && t.length !== e.length && (this.cache = new Float32Array(e.length)), yn(t, e)
    ...
    function xi(e, t, n, i) {
        return console.warn("WebGLProgram: #pragma unroll_loop shader syntax is deprecated. Please use #pragma unroll_loop_start syntax instead."), yi(e, t, n, i)
    }
    ...
    function bi(e, t, n) {
        ...
        var b, E, S = i + h,
            w = r + u,
            T = ri(l, l.VERTEX_SHADER, S),
            L = ri(l, l.FRAGMENT_SHADER, w);
        if (l.attachShader(x, T), l.attachShader(x, L), void 0 !== n.index0AttributeName ? l.bindAttribLocation(x, 0, n.index0AttributeName) : !0 === n.morphTargets && l.bindAttribLocation(x, 0, "position"), l.linkProgram(x), e.debug.checkShaderErrors) {
            ...
            } else "" !== A ? console.warn("THREE.WebGLProgram: gl.getProgramInfoLog()", A) : "" !== R && "" !== P || (C = !1);
            C && (this.diagnostics = {
                runnable: D,
                programLog: A,
                vertexShader: {
        ...
        return l.deleteShader(T), l.deleteShader(L), this.getUniforms = function() {
            return void 0 === b && (b = new ii(l, x)), b
        ...
        }, this.name = n.shaderName, this.id = ai++, this.cacheKey = t, this.usedTimes = 1, this.program = x, this.vertexShader = T, this.fragmentShader = L, this
    }
    ...
    function Ei(e, t, n) {
        ...
        this.getParameters = function(i, u, p, f, m, g, v) {
            ...
            return void 0 === r && (r = new bi(e, n, t), i.push(r)), r
    ...
    function Li() {
        ...
        function a(n, i, a, o, s, l) {
            ...
            return void 0 === c ? (c = {
                ...
                z: s,
                group: l
            }, e[t] = c) : (c.id = n.id, c.object = n, c.geometry = i, c.material = a, c.program = a.program || r, c.groupOrder = o, c.renderOrder = n.renderOrder, c.z = s, c.group = l), t++, c
        }
        return {
            opaque: n,
            transparent: i,
            ...
            sort: function(e, t) {
                n.length > 1 && n.sort(e || wi), i.length > 1 && i.sort(t || Ti)
            }
        }
    }
    ...
    function Ai() {
        ...
        return {
            get: function(n, i) {
                var r, a = e.get(n);
                return void 0 === a ? (r = new Li, e.set(n, new WeakMap), e.get(n).set(i, r), n.addEventListener("dispose", t)) : void 0 === (r = a.get(i)) && (r = new Li, a.set(i, r)), r
            },
            dispose: function() {
                e = new WeakMap
            }
        ...
        return {
            setup: function(e, r, o) {
                ...
                for (var b = e.length; d < b; d++) {
                    ...
                    if (E.isAmbientLight) c += S.r * w, h += S.g * w, u += S.b * w;
                    else if (E.isLightProbe)
                        for (var A = 0; A < 9; A++) i.probe[A].addScaledVector(E.sh.coefficients[A], w);
                    else if (E.isDirectionalLight) {
                        if ((D = t.get(E)).color.copy(E.color).multiplyScalar(E.intensity), D.direction.setFromMatrixPosition(E.matrixWorld), a.setFromMatrixPosition(E.target.matrixWorld), D.direction.sub(a), D.direction.transformDirection(M), E.castShadow) {
                            var R = E.shadow;
                            (P = n.get(E)).shadowBias = R.bias, P.shadowRadius = R.radius, P.shadowMapSize = R.mapSize, i.directionalShadow[p] = P, i.directionalShadowMap[p] = L, i.directionalShadowMatrix[p] = E.shadow.matrix, _++
                        }
                        i.directional[p] = D, p++
                    } else if (E.isSpotLight) {
                        if ((D = t.get(E)).position.setFromMatrixPosition(E.matrixWorld), D.position.applyMatrix4(M), D.color.copy(S).multiplyScalar(w), D.distance = T, D.direction.setFromMatrixPosition(E.matrixWorld), a.setFromMatrixPosition(E.target.matrixWorld), D.direction.sub(a), D.direction.transformDirection(M), D.coneCos = Math.cos(E.angle), D.penumbraCos = Math.cos(E.angle * (1 - E.penumbra)), D.decay = E.decay, E.castShadow) {
                            R = E.shadow;
                            (P = n.get(E)).shadowBias = R.bias, P.shadowRadius = R.radius, P.shadowMapSize = R.mapSize, i.spotShadow[m] = P, i.spotShadowMap[m] = L, i.spotShadowMatrix[m] = E.shadow.matrix, y++
                        }
                        i.spot[m] = D, m++
                    } else if (E.isRectAreaLight) {
                        (D = t.get(E)).color.copy(S).multiplyScalar(w), D.position.setFromMatrixPosition(E.matrixWorld), D.position.applyMatrix4(M), l.identity(), s.copy(E.matrixWorld), s.premultiply(M), l.extractRotation(s), D.halfWidth.set(.5 * E.width, 0, 0), D.halfHeight.set(0, .5 * E.height, 0), D.halfWidth.applyMatrix4(l), D.halfHeight.applyMatrix4(l), i.rectArea[g] = D, g++
                    } else if (E.isPointLight) {
                        if ((D = t.get(E)).position.setFromMatrixPosition(E.matrixWorld), D.position.applyMatrix4(M), D.color.copy(E.color).multiplyScalar(E.intensity), D.distance = E.distance, D.decay = E.decay, E.castShadow) {
                            var P;
                            R = E.shadow;
                            (P = n.get(E)).shadowBias = R.bias, P.shadowRadius = R.radius, P.shadowMapSize = R.mapSize, P.shadowCameraNear = R.camera.near, P.shadowCameraFar = R.camera.far, i.pointShadow[f] = P, i.pointShadowMap[f] = L, i.pointShadowMatrix[f] = E.shadow.matrix, x++
                        }
                        i.point[f] = D, f++
                    } else if (E.isHemisphereLight) {
                        var D;
                        (D = t.get(E)).direction.setFromMatrixPosition(E.matrixWorld), D.direction.transformDirection(M), D.direction.normalize(), D.skyColor.copy(E.color).multiplyScalar(w), D.groundColor.copy(E.groundColor).multiplyScalar(w), i.hemi[v] = D, v++
                    }
                }
                i.ambient[0] = c, i.ambient[1] = h, i.ambient[2] = u;
                var C = i.hash;
                C.directionalLength === p && C.pointLength === f && C.spotLength === m && C.rectAreaLength === g && C.hemiLength === v && C.numDirectionalShadows === _ && C.numPointShadows === x && C.numSpotShadows === y || (i.directional.length = p, i.spot.length = m, i.rectArea.length = g, i.point.length = f, i.hemi.length = v, i.directionalShadow.length = _, i.directionalShadowMap.length = _, i.pointShadow.length = x, i.pointShadowMap.length = x, i.spotShadow.length = y, i.spotShadowMap.length = y, i.directionalShadowMatrix.length = _, i.pointShadowMatrix.length = x, i.spotShadowMatrix.length = y, C.directionalLength = p, C.pointLength = f, C.spotLength = m, C.rectAreaLength = g, C.hemiLength = v, C.numDirectionalShadows = _, C.numPointShadows = x, C.numSpotShadows = y, i.version = Pi++)
            },
            state: i
        }
    }
    ...
    function Ui() {
        ...
        return {
            get: function(n, i) {
                var r;
                return !1 === e.has(n) ? (r = new Ni, e.set(n, new WeakMap), e.get(n).set(i, r), n.addEventListener("dispose", t)) : !1 === e.get(n).has(i) ? (r = new Ni, e.get(n).set(i, r)) : r = e.get(n).get(i), r
            },
            dispose: function() {
                e = new WeakMap
            }
    ...
    function Ii(e, t, n) {
        this.width = e, this.height = t, this.scissor = new ne(0, 0, e, t), this.scissorTest = !1, this.viewport = new ne(0, 0, e, t), n = n || {}, this.texture = new h(void 0, n.mapping, n.wrapS, n.wrapT, n.magFilter, n.minFilter, n.format, n.type, n.anisotropy, n.encoding), this.texture.image = {}, this.texture.image.width = e, this.texture.image.height = t, this.texture.generateMipmaps = void 0 !== n.generateMipmaps && n.generateMipmaps, this.texture.minFilter = void 0 !== n.minFilter ? n.minFilter : 1006, this.depthBuffer = void 0 === n.depthBuffer || n.depthBuffer, this.stencilBuffer = void 0 === n.stencilBuffer || n.stencilBuffer, this.depthTexture = void 0 !== n.depthTexture ? n.depthTexture : null
    }

    function Fi(e) {
        tt.call(this), this.type = "MeshDepthMaterial", this.depthPacking = 3200, this.skinning = !1, this.morphTargets = !1, this.map = null, this.alphaMap = null, this.displacementMap = null, this.displacementScale = 1, this.displacementBias = 0, this.wireframe = !1, this.wireframeLinewidth = 1, this.fog = !1, this.setValues(e)
    }

    function Oi(e) {
        tt.call(this), this.type = "MeshDistanceMaterial", this.referencePosition = new m, this.nearDistance = 1, this.farDistance = 1e3, this.skinning = !1, this.morphTargets = !1, this.map = null, this.alphaMap = null, this.displacementMap = null, this.displacementScale = 1, this.displacementBias = 0, this.fog = !1, this.setValues(e)
    }
    ...
    }), Fi.prototype = Object.create(tt.prototype), Fi.prototype.constructor = Fi, Fi.prototype.isMeshDepthMaterial = !0, Fi.prototype.copy = function(e) {
        return tt.prototype.copy.call(this, e), this.depthPacking = e.depthPacking, this.skinning = e.skinning, this.morphTargets = e.morphTargets, this.map = e.map, this.alphaMap = e.alphaMap, this.displacementMap = e.displacementMap, this.displacementScale = e.displacementScale, this.displacementBias = e.displacementBias, this.wireframe = e.wireframe, this.wireframeLinewidth = e.wireframeLinewidth, this
    }, Oi.prototype = Object.create(tt.prototype), Oi.prototype.constructor = Oi, Oi.prototype.isMeshDistanceMaterial = !0, Oi.prototype.copy = function(e) {
        return tt.prototype.copy.call(this, e), this.referencePosition.copy(e.referencePosition), this.nearDistance = e.nearDistance, this.farDistance = e.farDistance, this.skinning = e.skinning, this.morphTargets = e.morphTargets, this.map = e.map, this.alphaMap = e.alphaMap, this.displacementMap = e.displacementMap, this.displacementScale = e.displacementScale, this.displacementBias = e.displacementBias, this
    };
    ...
    function zi(e, t, n) {
        ...
        function y(t, n, i, r, a, o, s) {
            ...
            if (!0 === r.isPointLight && (c = x, d = t.customDistanceMaterial), void 0 === d) {
                ...
                var f = !1;
                !0 === t.isSkinnedMesh && (!0 === i.skinning ? f = !0 : console.warn("THREE.WebGLShadowMap: THREE.SkinnedMesh with material.skinning set to false:", t)), l = c(p, f, !0 === t.isInstancedMesh)
            } else l = d;
        ...
        function M(n, r, a, o, s) {
            if (!1 !== n.visible) {
                ...
                for (var g = n.children, v = 0, _ = g.length; v < _; v++) M(g[v], r, a, o, s)
            }
        }
            ...
            if (!1 !== g.enabled && (!1 !== g.autoUpdate || !1 !== g.needsUpdate) && 0 !== t.length) {
                ...
                for (var p = 0, f = t.length; p < f; p++) {
                    ...
                    if (void 0 !== _) {
                        ...
                        if (r.multiply(x), a.copy(_.mapSize), (r.x > n || r.y > n) && (r.x > n && (a.x = Math.floor(n / x.x), r.x = a.x * x.x, _.mapSize.x = a.x), r.y > n && (a.y = Math.floor(n / x.y), r.y = a.y * x.y, _.mapSize.y = a.y)), null === _.map && !_.isPointLightShadow && 3 === this.type) {
                            var y = {
                                minFilter: 1006,
                                magFilter: 1006,
                                format: 1023
                            };
                            _.map = new Ii(r.x, r.y, y), _.map.texture.name = m.name + ".shadowMap", _.mapPass = new Ii(r.x, r.y, y), _.camera.updateProjectionMatrix()
                        }
                        if (null === _.map) {
                            y = {
                                minFilter: 1003,
                            ...
                            _.map = new Ii(r.x, r.y, y), _.map.texture.name = m.name + ".shadowMap", _.camera.updateProjectionMatrix()
                        }
                        e.setRenderTarget(_.map), e.clear();
                        for (var b = _.getViewportCount(), E = 0; E < b; E++) {
                            var S = _.getViewport(E);
                            s.set(a.x * S.x, a.y * S.y, a.x * S.z, a.y * S.w), d.viewport(s), _.updateMatrices(m, E), i = _.getFrustum(), M(o, l, _.camera, m, this.type)
                        }
                        _.isPointLightShadow || 3 !== this.type || v(_, l)
                    } else console.warn("THREE.WebGLShadowMap:", m, "has no shadow.")
                }
                g.needsUpdate = !1, e.setRenderTarget(c, h, u)
            }
        }
    }
    ...
    function Bi(e, t, n) {
        ...
        var r = new function() {
            ...
            A = !1,
            R = 0,
            P = e.getParameter(e.VERSION); - 1 !== P.indexOf("WebGL") ? (R = parseFloat(/^WebGL\ ([0-9])/.exec(P)[1]), A = R >= 1) : -1 !== P.indexOf("OpenGL ES") && (R = parseFloat(/^OpenGL\ ES\ ([0-9])/.exec(P)[1]), A = R >= 2);
        var D = null,
            C = {},
            N = new ne,
            U = new ne;
        ...
        function O(n, r) {
            (l[n] = 1, 0 === c[n] && (e.enableVertexAttribArray(n), c[n] = 1), h[n] !== r) && ((i ? e : t.get("ANGLE_instanced_arrays"))[i ? "vertexAttribDivisor" : "vertexAttribDivisorANGLE"](n, r), h[n] = r)
        }
        ...
        F[e.TEXTURE_2D] = I(e.TEXTURE_2D, e.TEXTURE_2D, 1), F[e.TEXTURE_CUBE_MAP] = I(e.TEXTURE_CUBE_MAP, e.TEXTURE_CUBE_MAP_POSITIVE_X, 6), r.setClear(0, 0, 0, 1), a.setClear(1), o.setClear(0), z(e.DEPTH_TEST), a.setFunc(3), W(!1), X(1), z(e.CULL_FACE), k(0);
        var G = {
            100: e.FUNC_ADD,
            101: e.FUNC_SUBTRACT,
        ...
        function k(t, n, i, r, a, o, s, l) {
            if (0 !== t) {
                if (p || (z(e.BLEND), p = !0), 5 === t) a = a || n, o = o || i, s = s || r, n === m && a === _ || (e.blendEquationSeparate(G[n], G[a]), m = n, _ = a), i === g && r === v && o === x && s === y || (e.blendFuncSeparate(V[i], V[r], V[o], V[s]), g = i, v = r, x = o, y = s), f = t, M = null;
                else if (t !== f || l !== M) {
                    if (100 === m && 100 === _ || (e.blendEquation(e.FUNC_ADD), m = 100, _ = 100), l) switch (t) {
                        case 1:
                    ...
                    g = null, v = null, x = null, y = null, f = t, M = l
                }
            } else p && (B(e.BLEND), p = !1)
        }
        ...
        function X(t) {
            0 !== t ? (z(e.CULL_FACE), t !== E && (1 === t ? e.cullFace(e.BACK) : 2 === t ? e.cullFace(e.FRONT) : e.cullFace(e.FRONT_AND_BACK))) : B(e.CULL_FACE), E = t
        }

        function j(t, n, i) {
            t ? (z(e.POLYGON_OFFSET_FILL), w === n && T === i || (e.polygonOffset(n, i), w = n, T = i)) : B(e.POLYGON_OFFSET_FILL)
        }
        ...
        return {
            ...
            setMaterial: function(t, n) {
                ...
                var i = 1 === t.side;
                n && (i = !i), W(i), 1 === t.blending && !1 === t.transparent ? k(0) : k(t.blending, t.blendEquation, t.blendSrc, t.blendDst, t.blendEquationAlpha, t.blendSrcAlpha, t.blendDstAlpha, t.premultipliedAlpha), a.setFunc(t.depthFunc), a.setTest(t.depthTest), a.setMask(t.depthWrite), r.setMask(t.colorWrite);
                var s = t.stencilWrite;
                o.setTest(s), s && (o.setMask(t.stencilWriteMask), o.setFunc(t.stencilFunc, t.stencilRef, t.stencilFuncMask), o.setOp(t.stencilFail, t.stencilZFail, t.stencilZPass)), j(t.polygonOffset, t.polygonOffsetFactor, t.polygonOffsetUnits)
            },
            setFlipSided: W,
            setCullFace: X,
            ...
            bindTexture: function(t, n) {
                ...
                void 0 === i && (i = {
                    type: void 0,
                    texture: void 0
                }, C[D] = i), i.type === t && i.texture === n || (e.bindTexture(t, n || F[t]), i.type = t, i.texture = n)
            },
            ...
            reset: function() {
                ...
                u = {}, D = null, C = {}, d = null, f = null, b = null, E = null, r.reset(), a.reset(), o.reset()
            }
        }
    }
    ...
    function Gi(e, t, n, i, a, o, s) {
        ...
        function v(e, t, n, i) {
            ...
            if ((e.width > i || e.height > i) && (a = i / Math.max(e.width, e.height)), a < 1 || !0 === t) {
                if ("undefined" != typeof HTMLImageElement && e instanceof HTMLImageElement || "undefined" != typeof HTMLCanvasElement && e instanceof HTMLCanvasElement || "undefined" != typeof ImageBitmap && e instanceof ImageBitmap) {
                    ...
                    void 0 === l && (l = g(s, c));
                    var h = n ? g(s, c) : l;
                    return h.width = s, h.height = c, h.getContext("2d").drawImage(e, 0, 0, s, c), console.warn("THREE.WebGLRenderer: Texture has been resized from (" + e.width + "x" + e.height + ") to (" + s + "x" + c + ")."), h
                }
        ...
        function M(n, i, r) {
            ...
            var a = i;
            return i === e.RED && (r === e.FLOAT && (a = e.R32F), r === e.HALF_FLOAT && (a = e.R16F), r === e.UNSIGNED_BYTE && (a = e.R8)), i === e.RGB && (r === e.FLOAT && (a = e.RGB32F), r === e.HALF_FLOAT && (a = e.RGB16F), r === e.UNSIGNED_BYTE && (a = e.RGB8)), i === e.RGBA && (r === e.FLOAT && (a = e.RGBA32F), r === e.HALF_FLOAT && (a = e.RGBA16F), r === e.UNSIGNED_BYTE && (a = e.RGBA8)), a !== e.R16F && a !== e.R32F && a !== e.RGBA16F && a !== e.RGBA32F || t.get("EXT_color_buffer_float"), a
        }
        ...
        function T(t, r) {
            ...
            if (t.isVideoTexture && function(e) {
                ...
                if (void 0 === o) console.warn("THREE.WebGLRenderer: Texture marked for update but image is undefined");
                    ...
                    if (!1 !== o.complete) return void N(a, t, r);
        ...
        function L(t, r) {
            if (6 === t.image.length) {
                ...
                if (t.version > 0 && a.__version !== t.version) {
                    C(a, t), n.activeTexture(e.TEXTURE0 + r), n.bindTexture(e.TEXTURE_CUBE_MAP, a.__webglTexture), e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL, t.flipY);
                    ...
                    var p, f = h[0],
                        ...
                        b = o.convert(t.type),
                        E = M(t.internalFormat, g, b);
                    if (D(e.TEXTURE_CUBE_MAP, t, m), s) {
                        for (d = 0; d < 6; d++) {
                            p = h[d].mipmaps;
                    ...
                    x(t, m) && y(e.TEXTURE_CUBE_MAP, t, f.width, f.height), a.__version = t.version, t.onUpdate && t.onUpdate(t)
                } else n.activeTexture(e.TEXTURE0 + r), n.bindTexture(e.TEXTURE_CUBE_MAP, a.__webglTexture)
            }
        }
        ...
        function D(n, r, o) {
            o ? (e.texParameteri(n, e.TEXTURE_WRAP_S, R[r.wrapS]), e.texParameteri(n, e.TEXTURE_WRAP_T, R[r.wrapT]), n !== e.TEXTURE_3D && n !== e.TEXTURE_2D_ARRAY || e.texParameteri(n, e.TEXTURE_WRAP_R, R[r.wrapR]), e.texParameteri(n, e.TEXTURE_MAG_FILTER, P[r.magFilter]), e.texParameteri(n, e.TEXTURE_MIN_FILTER, P[r.minFilter])) : (e.texParameteri(n, e.TEXTURE_WRAP_S, e.CLAMP_TO_EDGE), e.texParameteri(n, e.TEXTURE_WRAP_T, e.CLAMP_TO_EDGE), n !== e.TEXTURE_3D && n !== e.TEXTURE_2D_ARRAY || e.texParameteri(n, e.TEXTURE_WRAP_R, e.CLAMP_TO_EDGE), 1001 === r.wrapS && 1001 === r.wrapT || console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."), e.texParameteri(n, e.TEXTURE_MAG_FILTER, b(r.magFilter)), e.texParameteri(n, e.TEXTURE_MIN_FILTER, b(r.minFilter)), 1003 !== r.minFilter && 1006 !== r.minFilter && console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter."));
            var s = t.get("EXT_texture_filter_anisotropic");
            if (s) {
                if (1015 === r.type && null === t.get("OES_texture_float_linear")) return;
                if (1016 === r.type && null === (c || t.get("OES_texture_half_float_linear"))) return;
                (r.anisotropy > 1 || i.get(r).__currentAnisotropy) && (e.texParameterf(n, s.TEXTURE_MAX_ANISOTROPY_EXT, Math.min(r.anisotropy, a.getMaxAnisotropy())), i.get(r).__currentAnisotropy = r.anisotropy)
            }
        }

        function C(t, n) {
            void 0 === t.__webglInit && (t.__webglInit = !0, n.addEventListener("dispose", E), t.__webglTexture = e.createTexture(), s.memory.textures++)
        }

        function N(t, i, r) {
            var a = e.TEXTURE_2D;
            i.isDataTexture2DArray && (a = e.TEXTURE_2D_ARRAY), i.isDataTexture3D && (a = e.TEXTURE_3D), C(t, i), n.activeTexture(e.TEXTURE0 + r), n.bindTexture(a, t.__webglTexture), e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL, i.flipY), e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL, i.premultiplyAlpha), e.pixelStorei(e.UNPACK_ALIGNMENT, i.unpackAlignment);
            var s = function(e) {
            ...
            D(a, i, h);
            var m, g = i.mipmaps;
            if (i.isDepthTexture) f = e.DEPTH_COMPONENT, c ? f = 1015 === i.type ? e.DEPTH_COMPONENT32F : 1014 === i.type ? e.DEPTH_COMPONENT24 : 1020 === i.type ? e.DEPTH24_STENCIL8 : e.DEPTH_COMPONENT16 : 1015 === i.type && console.error("WebGLRenderer: Floating point depth texture requires WebGL2."), 1026 === i.format && f === e.DEPTH_COMPONENT && 1012 !== i.type && 1014 !== i.type && (console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."), i.type = 1012, p = o.convert(i.type)), 1027 === i.format && f === e.DEPTH_COMPONENT && (f = e.DEPTH_STENCIL, 1020 !== i.type && (console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."), i.type = 1020, p = o.convert(i.type))), n.texImage2D(e.TEXTURE_2D, 0, f, l.width, l.height, 0, u, p, null);
            else if (i.isDataTexture)
                if (g.length > 0 && h) {
                    for (var b = 0, E = g.length; b < E; b++) m = g[b], n.texImage2D(e.TEXTURE_2D, b, f, m.width, m.height, 0, u, p, m.data);
                    i.generateMipmaps = !1, t.__maxMipLevel = g.length - 1
                } else n.texImage2D(e.TEXTURE_2D, 0, f, l.width, l.height, 0, u, p, l.data), t.__maxMipLevel = 0;
            else if (i.isCompressedTexture) {
                for (b = 0, E = g.length; b < E; b++) m = g[b], 1023 !== i.format && 1022 !== i.format ? null !== u ? n.compressedTexImage2D(e.TEXTURE_2D, b, f, m.width, m.height, 0, m.data) : console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()") : n.texImage2D(e.TEXTURE_2D, b, f, m.width, m.height, 0, u, p, m.data);
                t.__maxMipLevel = g.length - 1
            } else if (i.isDataTexture2DArray) n.texImage3D(e.TEXTURE_2D_ARRAY, 0, f, l.width, l.height, l.depth, 0, u, p, l.data), t.__maxMipLevel = 0;
            else if (i.isDataTexture3D) n.texImage3D(e.TEXTURE_3D, 0, f, l.width, l.height, l.depth, 0, u, p, l.data), t.__maxMipLevel = 0;
            else if (g.length > 0 && h) {
                for (b = 0, E = g.length; b < E; b++) m = g[b], n.texImage2D(e.TEXTURE_2D, b, f, u, p, m);
                i.generateMipmaps = !1, t.__maxMipLevel = g.length - 1
            } else n.texImage2D(e.TEXTURE_2D, 0, f, u, p, l), t.__maxMipLevel = 0;
            x(i, h) && y(a, i, l.width, l.height), t.__version = i.version, i.onUpdate && i.onUpdate(i)
        }
        ...
        function U(t, r, a, s) {
            ...
            n.texImage2D(s, 0, h, r.width, r.height, 0, l, c, null), e.bindFramebuffer(e.FRAMEBUFFER, t), e.framebufferTexture2D(e.FRAMEBUFFER, a, s, i.get(r.texture).__webglTexture, 0), e.bindFramebuffer(e.FRAMEBUFFER, null)
        }
        ...
        function F(t) {
            ...
            if (t.depthTexture) {
                ...
                ! function(t, n) {
                    ...
                    if (1026 === n.depthTexture.format) e.framebufferTexture2D(e.FRAMEBUFFER, e.DEPTH_ATTACHMENT, e.TEXTURE_2D, r, 0);
                    else {
                ...
                for (var a = 0; a < 6; a++) e.bindFramebuffer(e.FRAMEBUFFER, n.__webglFramebuffer[a]), n.__webglDepthbuffer[a] = e.createRenderbuffer(), I(n.__webglDepthbuffer[a], t, !1)
            } else e.bindFramebuffer(e.FRAMEBUFFER, n.__webglFramebuffer), n.__webglDepthbuffer = e.createRenderbuffer(), I(n.__webglDepthbuffer, t, !1);
        ...
        this.allocateTextureUnit = function() {
            ...
            var a = i.get(t);
            t.version > 0 && a.__version !== t.version ? N(a, t, r) : (n.activeTexture(e.TEXTURE0 + r), n.bindTexture(e.TEXTURE_2D_ARRAY, a.__webglTexture))
        }, this.setTexture3D = function(t, r) {
            var a = i.get(t);
            t.version > 0 && a.__version !== t.version ? N(a, t, r) : (n.activeTexture(e.TEXTURE0 + r), n.bindTexture(e.TEXTURE_3D, a.__webglTexture))
        }, this.setTextureCube = L, this.setTextureCubeDynamic = A, this.setupRenderTarget = function(t) {
            var r = i.get(t),
                a = i.get(t.texture);
            t.addEventListener("dispose", S), a.__webglTexture = e.createTexture(), s.memory.textures++;
            var l = !0 === t.isWebGLCubeRenderTarget,
                h = !0 === t.isWebGLMultisampleRenderTarget,
                u = _(t) || c;
            if (!c || 1022 !== t.texture.format || 1015 !== t.texture.type && 1016 !== t.texture.type || (t.texture.format = 1023, console.warn("THREE.WebGLRenderer: Rendering to textures with RGB format is not supported. Using RGBA format instead.")), l) {
                r.__webglFramebuffer = [];
                for (var d = 0; d < 6; d++) r.__webglFramebuffer[d] = e.createFramebuffer()
            } else if (r.__webglFramebuffer = e.createFramebuffer(), h)
                if (c) {
                    r.__webglMultisampledFramebuffer = e.createFramebuffer(), r.__webglColorRenderbuffer = e.createRenderbuffer(), e.bindRenderbuffer(e.RENDERBUFFER, r.__webglColorRenderbuffer);
                    var p = o.convert(t.texture.format),
                        f = o.convert(t.texture.type),
                        m = M(t.texture.internalFormat, p, f),
                        g = O(t);
                    e.renderbufferStorageMultisample(e.RENDERBUFFER, g, m, t.width, t.height), e.bindFramebuffer(e.FRAMEBUFFER, r.__webglMultisampledFramebuffer), e.framebufferRenderbuffer(e.FRAMEBUFFER, e.COLOR_ATTACHMENT0, e.RENDERBUFFER, r.__webglColorRenderbuffer), e.bindRenderbuffer(e.RENDERBUFFER, null), t.depthBuffer && (r.__webglDepthRenderbuffer = e.createRenderbuffer(), I(r.__webglDepthRenderbuffer, t, !0)), e.bindFramebuffer(e.FRAMEBUFFER, null)
                } else console.warn("THREE.WebGLRenderer: WebGLMultisampleRenderTarget can only be used with WebGL2.");
            if (l) {
                n.bindTexture(e.TEXTURE_CUBE_MAP, a.__webglTexture), D(e.TEXTURE_CUBE_MAP, t.texture, u);
                for (d = 0; d < 6; d++) U(r.__webglFramebuffer[d], t, e.COLOR_ATTACHMENT0, e.TEXTURE_CUBE_MAP_POSITIVE_X + d);
                x(t.texture, u) && y(e.TEXTURE_CUBE_MAP, t.texture, t.width, t.height), n.bindTexture(e.TEXTURE_CUBE_MAP, null)
            } else n.bindTexture(e.TEXTURE_2D, a.__webglTexture), D(e.TEXTURE_2D, t.texture, u), U(r.__webglFramebuffer, t, e.COLOR_ATTACHMENT0, e.TEXTURE_2D), x(t.texture, u) && y(e.TEXTURE_2D, t.texture, t.width, t.height), n.bindTexture(e.TEXTURE_2D, null);
            t.depthBuffer && F(t)
            ...
            if (x(r, _(t) || c)) {
                ...
                n.bindTexture(a, o), y(a, r, t.width, t.height), n.bindTexture(a, null)
            }
            ...
            if (t.isWebGLMultisampleRenderTarget)
                if (c) {
                    ...
                    t.depthBuffer && (o |= e.DEPTH_BUFFER_BIT), t.stencilBuffer && (o |= e.STENCIL_BUFFER_BIT), e.blitFramebuffer(0, 0, r, a, 0, 0, r, a, o, e.NEAREST), e.bindFramebuffer(e.FRAMEBUFFER, n.__webglMultisampledFramebuffer)
                } else console.warn("THREE.WebGLRenderer: WebGLMultisampleRenderTarget can only be used with WebGL2.")
        }, this.safeSetTexture2D = function(e, t) {
            e && e.isWebGLRenderTarget && (!1 === z && (console.warn("THREE.WebGLTextures.safeSetTexture2D: don't use render targets as textures. Use their .texture property instead."), z = !0), e = e.texture), T(e, t)
        }, this.safeSetTextureCube = function(e, t) {
            e && e.isWebGLCubeRenderTarget && (!1 === B && (console.warn("THREE.WebGLTextures.safeSetTextureCube: don't use cube render targets as textures. Use their .texture property instead."), B = !0), e = e.texture), e && e.isCubeTexture || Array.isArray(e.image) && 6 === e.image.length ? L(e, t) : A(e, t)
        }
    }
    ...
    function Hi(e, t, n) {
        ...
        return {
            convert: function(n) {
                ...
                if (1016 === n) return i ? e.HALF_FLOAT : null !== (r = t.get("OES_texture_half_float")) ? r.HALF_FLOAT_OES : null;
                ...
                if (36196 === n) return null !== (r = t.get("WEBGL_compressed_texture_etc1")) ? r.COMPRESSED_RGB_ETC1_WEBGL : null;
    ...
    function Vi() {
        ye.call(this), this.type = "Camera", this.matrixWorldInverse = new Y, this.projectionMatrix = new Y, this.projectionMatrixInverse = new Y
    }

    function ki(e, t, n, i) {
        Vi.call(this), this.type = "PerspectiveCamera", this.fov = void 0 !== e ? e : 50, this.zoom = 1, this.near = void 0 !== n ? n : .1, this.far = void 0 !== i ? i : 2e3, this.focus = 10, this.aspect = void 0 !== t ? t : 1, this.view = null, this.filmGauge = 35, this.filmOffset = 0, this.updateProjectionMatrix()
    }
    ...
    function Yi(e, t) {
        var n = this,
            ...
            c = new Map,
            h = new ki;
        h.layers.enable(1), h.viewport = new ne;
        var u = new ki;
        u.layers.enable(2), u.viewport = new ne;
        var d = [h, u],
            p = new Wi;
        ...
        function _() {
            c.forEach((function(e, t) {
                e.disconnect(t)
            })), c.clear(), e.setFramebuffer(null), e.setRenderTarget(e.getRenderTarget()), w.stop(), n.isPresenting = !1, n.dispatchEvent({
                type: "sessionend"
            })
        }

        function x(e) {
            a = e, w.setContext(i), w.start(), n.isPresenting = !0, n.dispatchEvent({
                type: "sessionstart"
            })
        }
        ...
        this.enabled = !1, this.isPresenting = !1, this.getController = function(e) {
            var t = l[e];
            return void 0 === t && (t = new ji, l[e] = t), t.getTargetRaySpace()
        }, this.getControllerGrip = function(e) {
            var t = l[e];
            return void 0 === t && (t = new ji, l[e] = t), t.getGripSpace()
            ...
            if (null !== (i = e)) {
                i.addEventListener("select", v), i.addEventListener("selectstart", v), i.addEventListener("selectend", v), i.addEventListener("squeeze", v), i.addEventListener("squeezestart", v), i.addEventListener("squeezeend", v), i.addEventListener("end", _);
                ...
                i.updateRenderState({
                    baseLayer: s
                }), i.requestReferenceSpace(o).then(x), i.addEventListener("inputsourceschange", y)
            }
        };
        var M = new m,
            b = new m;
        ...
        this.getCamera = function(e) {
            p.near = u.near = h.near = e.near, p.far = u.far = h.far = e.far, f === p.near && g === p.far || (i.updateRenderState({
                depthNear: p.near,
                depthFar: p.far
            }), f = p.near, g = p.far);
            var t = e.parent,
            ...
            return 2 === n.length ? function(e, t, n) {
                M.setFromMatrixPosition(t.matrixWorld), b.setFromMatrixPosition(n.matrixWorld);
    ...
    function Zi(e) {
        tt.call(this), this.type = "PointsMaterial", this.color = new Q(16777215), this.map = null, this.alphaMap = null, this.size = 1, this.sizeAttenuation = !0, this.morphTargets = !1, this.setValues(e)
    }
    Vi.prototype = Object.assign(Object.create(ye.prototype), {
        constructor: Vi,
        isCamera: !0,
        copy: function(e, t) {
            return ye.prototype.copy.call(this, e, t), this.matrixWorldInverse.copy(e.matrixWorldInverse), this.projectionMatrix.copy(e.projectionMatrix), this.projectionMatrixInverse.copy(e.projectionMatrixInverse), this
        },
        getWorldDirection: function(e) {
            void 0 === e && (console.warn("THREE.Camera: .getWorldDirection() target is now required"), e = new m), this.updateMatrixWorld(!0);
            var t = this.matrixWorld.elements;
            return e.set(-t[8], -t[9], -t[10]).normalize()
        },
        updateMatrixWorld: function(e) {
            ye.prototype.updateMatrixWorld.call(this, e), this.matrixWorldInverse.getInverse(this.matrixWorld)
        },
        updateWorldMatrix: function(e, t) {
            ye.prototype.updateWorldMatrix.call(this, e, t), this.matrixWorldInverse.getInverse(this.matrixWorld)
        },
        clone: function() {
            return (new this.constructor).copy(this)
        }
        ...
        copy: function(e, t) {
            return Vi.prototype.copy.call(this, e, t), this.fov = e.fov, this.zoom = e.zoom, this.near = e.near, this.far = e.far, this.focus = e.focus, this.aspect = e.aspect, this.view = null === e.view ? null : Object.assign({}, e.view), this.filmGauge = e.filmGauge, this.filmOffset = e.filmOffset, this
        },
        setFocalLength: function(e) {
            var t = .5 * this.getFilmHeight() / e;
            this.fov = 2 * r.RAD2DEG * Math.atan(t), this.updateProjectionMatrix()
        },
        ...
        updateProjectionMatrix: function() {
            ...
            if (null !== this.view && this.view.enabled) {
                var s = o.fullWidth,
                    l = o.fullHeight;
                a += o.offsetX * i / s, t -= o.offsetY * n / l, i *= o.width / s, n *= o.height / l
            }
            var c = this.filmOffset;
            0 !== c && (a += e * c / this.getFilmWidth()), this.projectionMatrix.makePerspective(a, a + i, t, t - n, e, this.far), this.projectionMatrixInverse.getInverse(this.projectionMatrix)
        },
        toJSON: function(e) {
            var t = ye.prototype.toJSON.call(this, e);
        ...
        getTargetRaySpace: function() {
            return null === this._targetRay && (this._targetRay = new Xi, this._targetRay.matrixAutoUpdate = !1, this._targetRay.visible = !1), this._targetRay
        },
        getGripSpace: function() {
            return null === this._grip && (this._grip = new Xi, this._grip.matrixAutoUpdate = !1, this._grip.visible = !1), this._grip
        },
        dispatchEvent: function(e) {
        ...
        update: function(e, t, n) {
            var i = null,
                ...
                a = this._targetRay,
                o = this._grip;
            return e && (null !== a && null !== (i = t.getPose(e.targetRaySpace, n)) && (a.matrix.fromArray(i.transform.matrix), a.matrix.decompose(a.position, a.rotation, a.scale)), null !== o && e.gripSpace && null !== (r = t.getPose(e.gripSpace, n)) && (o.matrix.fromArray(r.transform.matrix), o.matrix.decompose(o.position, o.rotation, o.scale))), null !== a && (a.visible = null !== i), null !== o && (o.visible = null !== r), this
        }
    }), Object.assign(Yi.prototype, a.prototype), Object.assign(qi.prototype, {
        isFog: !0,
        clone: function() {
    ...
    }), Zi.prototype = Object.create(tt.prototype), Zi.prototype.constructor = Zi, Zi.prototype.isPointsMaterial = !0, Zi.prototype.copy = function(e) {
        return tt.prototype.copy.call(this, e), this.color.copy(e.color), this.map = e.map, this.alphaMap = e.alphaMap, this.size = e.size, this.sizeAttenuation = e.sizeAttenuation, this.morphTargets = e.morphTargets, this
    };
    var Ji = new Y,
        Qi = new pt,
        Ki = new C,
    ...
    function er(e, t) {
        ye.call(this), this.type = "Points", this.geometry = void 0 !== e ? e : new Je, this.material = void 0 !== t ? t : new Zi, this.updateMorphTargets()
    }
    ...
    function tr(e, t, n, i, r, a, o) {
        ...
        if (s < n) {
            var l = new m;
            Qi.closestPointToPoint(e, l), l.applyMatrix4(i);
    ...
    er.prototype = Object.assign(Object.create(ye.prototype), {
        ...
        raycast: function(e, t) {
            ...
            if (null === n.boundingSphere && n.computeBoundingSphere(), Ki.copy(n.boundingSphere), Ki.applyMatrix4(i), Ki.radius += r, !1 !== e.ray.intersectsSphere(Ki)) {
                Ji.getInverse(i), Qi.copy(e.ray).applyMatrix4(Ji);
                ...
                if (n.isBufferGeometry) {
                    ...
                    if (null !== s)
                        for (var c = s.array, h = 0, u = c.length; h < u; h++) {
                            var d = c[h];
                            $i.fromArray(l, 3 * d), tr($i, d, o, i, e, t, this)
                        } else {
                            h = 0;
                            for (var p = l.length / 3; h < p; h++) $i.fromArray(l, 3 * h), tr($i, h, o, i, e, t, this)
                        }
                } else {
                    var f = n.vertices;
                    for (h = 0, p = f.length; h < p; h++) tr(f[h], h, o, i, e, t, this)
                }
            }
        },
        updateMorphTargets: function() {
    ...
    function rr(e) {
        this.manager = void 0 !== e ? e : ir, this.crossOrigin = "anonymous", this.path = "", this.resourcePath = ""
    }
    ...
    return Object.assign(rr.prototype, {
        ...
        load: function(e, t, n, i) {
            ...
            function s() {
                o.removeEventListener("load", s, !1), o.removeEventListener("error", l, !1), nr.add(e, this), t && t(this), r.manager.itemEnd(e)
            }

            function l(t) {
                o.removeEventListener("load", s, !1), o.removeEventListener("error", l, !1), i && i(t), r.manager.itemError(e), r.manager.itemEnd(e)
            }
    ...
    }), e.AlwaysDepth = 1, e.BufferAttribute = De, e.BufferGeometry = Je, e.Color = Q, e.Fog = qi, e.Group = Xi, e.LinearFilter = 1006, e.LinearMipmapLinearFilter = 1008, e.LinearMipmapNearestFilter = 1007, e.Mesh = kt, e.MeshBasicMaterial = wt, e.NearestFilter = 1003, e.NearestMipmapLinearFilter = 1005, e.NearestMipmapNearestFilter = 1004, e.PerspectiveCamera = ki, e.Points = er, e.PointsMaterial = Zi, e.Scene = Me, e.TextureLoader = or, e.Vector3 = m, e.WebGLRenderer = function(e) {
        ...
        var v, _, x, y, M, b, E, S, w, T, L, A, R, P, D, C, N, U, I = this,
            F = !1,
            O = null,
            z = 0,
            G = 0,
        ...
        try {
            ...
            if (t.addEventListener("webglcontextlost", _e, !1), t.addEventListener("webglcontextrestored", xe, !1), null === (v = n || t.getContext("webgl", fe) || t.getContext("experimental-webgl", fe))) throw null !== t.getContext("webgl") ? new Error("Error creating WebGL context with your selected attributes.") : new Error("Error creating WebGL context.");
        ...
        function me() {
            _ = new Kt(v), !1 === (x = new Jt(v, _, e)).isWebGL2 && (_.get("WEBGL_depth_texture"), _.get("OES_texture_float"), _.get("OES_texture_half_float"), _.get("OES_texture_half_float_linear"), _.get("OES_standard_derivatives"), _.get("OES_element_index_uint"), _.get("ANGLE_instanced_arrays")), _.get("OES_texture_float_linear"), U = new Hi(v, _, x), (y = new Bi(v, _, x)).scissor(Z.copy(ae).multiplyScalar($).floor()), y.viewport(q.copy(re).multiplyScalar($).floor()), M = new tn(v), b = new Si, E = new Gi(v, _, y, b, x, U, M), S = new Ee(v, x), w = new $t(v, S, M), T = new an(v, w, S, M), D = new rn(v), L = new Ei(I, _, x), A = new Ai, R = new Ui, P = new qt(I, y, T, c), C = new Zt(v, _, M, x), N = new en(v, _, M, x), M.programs = L.programs, I.capabilities = x, I.extensions = _, I.properties = b, I.renderLists = A, I.state = y, I.info = M
        }
        me();
        var ge = new Yi(I, v);
        this.xr = ge;
        ...
        function xe() {
            console.log("THREE.WebGLRenderer: Context Restored."), F = !1, me()
        }
        ...
        this.shadowMap = ve, this.getContext = function() {
            ...
            return void 0 === e && (console.warn("WebGLRenderer: .getsize() now requires a Vector2 as an argument"), e = new o), e.set(Q, K)
        }, this.setSize = function(e, n, i) {
            ge.isPresenting ? console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.") : (Q = e, K = n, t.width = Math.floor(e * $), t.height = Math.floor(n * $), !1 !== i && (t.style.width = e + "px", t.style.height = n + "px"), this.setViewport(0, 0, e, n))
        }, this.getDrawingBufferSize = function(e) {
            return void 0 === e && (console.warn("WebGLRenderer: .getdrawingBufferSize() now requires a Vector2 as an argument"), e = new o), e.set(Q * $, K * $).floor()
        }, this.setDrawingBufferSize = function(e, n, i) {
            Q = e, K = n, $ = i, t.width = Math.floor(e * i), t.height = Math.floor(n * i), this.setViewport(0, 0, e, n)
        }, this.getCurrentViewport = function(e) {
            return void 0 === e && (console.warn("WebGLRenderer: .getCurrentViewport() now requires a Vector4 as an argument"), e = new ne), e.copy(q)
        }, this.getViewport = function(e) {
            return e.copy(re)
        }, this.setViewport = function(e, t, n, i) {
            e.isVector4 ? re.set(e.x, e.y, e.z, e.w) : re.set(e, t, n, i), y.viewport(q.copy(re).multiplyScalar($).floor())
        }, this.getScissor = function(e) {
            return e.copy(ae)
        }, this.setScissor = function(e, t, n, i) {
            e.isVector4 ? ae.set(e.x, e.y, e.z, e.w) : ae.set(e, t, n, i), y.scissor(Z.copy(ae).multiplyScalar($).floor())
            ...
            var i = 0;
            (void 0 === e || e) && (i |= v.COLOR_BUFFER_BIT), (void 0 === t || t) && (i |= v.DEPTH_BUFFER_BIT), (void 0 === n || n) && (i |= v.STENCIL_BUFFER_BIT), v.clear(i)
            ...
            t.removeEventListener("webglcontextlost", _e, !1), t.removeEventListener("webglcontextrestored", xe, !1), A.dispose(), R.dispose(), b.dispose(), T.dispose(), ge.dispose(), Le.stop()
            ...
            e.hasPositions && (v.bindBuffer(v.ARRAY_BUFFER, n.position), v.bufferData(v.ARRAY_BUFFER, e.positionArray, v.DYNAMIC_DRAW), y.enableAttribute(i.position), v.vertexAttribPointer(i.position, 3, v.FLOAT, !1, 0, 0)), e.hasNormals && (v.bindBuffer(v.ARRAY_BUFFER, n.normal), v.bufferData(v.ARRAY_BUFFER, e.normalArray, v.DYNAMIC_DRAW), y.enableAttribute(i.normal), v.vertexAttribPointer(i.normal, 3, v.FLOAT, !1, 0, 0)), e.hasUvs && (v.bindBuffer(v.ARRAY_BUFFER, n.uv), v.bufferData(v.ARRAY_BUFFER, e.uvArray, v.DYNAMIC_DRAW), y.enableAttribute(i.uv), v.vertexAttribPointer(i.uv, 2, v.FLOAT, !1, 0, 0)), e.hasColors && (v.bindBuffer(v.ARRAY_BUFFER, n.color), v.bufferData(v.ARRAY_BUFFER, e.colorArray, v.DYNAMIC_DRAW), y.enableAttribute(i.color), v.vertexAttribPointer(i.color, 3, v.FLOAT, !1, 0, 0)), y.disableUnusedAttributes(), v.drawArrays(v.TRIANGLES, 0, e.count), e.count = 0
        };
        var we = new Me;
        this.renderBufferDirect = function(e, t, n, i, r, a) {
            ...
            y.setMaterial(i, o);
            var l = !1;
            W.geometry === n.id && W.program === s.id && W.wireframe === (!0 === i.wireframe) || (W.geometry = n.id, W.program = s.id, W.wireframe = !0 === i.wireframe, l = !0), (i.morphTargets || i.morphNormals) && (D.update(r, n, i, s), l = !0), !0 === r.isInstancedMesh && (l = !0);
            var c = n.index,
            ...
            var p = C;
            null !== c && (u = S.get(c), (p = N).setIndex(u)), l && (! function(e, t, n, i) {
                if (!1 === x.isWebGL2 && (e.isInstancedMesh || t.isInstancedBufferGeometry) && null === _.get("ANGLE_instanced_arrays")) return;
                y.initAttributes();
                var r = t.attributes,
                    a = i.getAttributes(),
                        ...
                        if (void 0 !== c) {
                            ...
                            if (c.isInterleavedBufferAttribute) {
                                var m = c.data,
                                    g = m.stride,
                                    M = c.offset;
                                m && m.isInstancedInterleavedBuffer ? (y.enableAttributeAndDivisor(l, m.meshPerAttribute), void 0 === t.maxInstancedCount && (t.maxInstancedCount = m.meshPerAttribute * m.count)) : y.enableAttribute(l), v.bindBuffer(v.ARRAY_BUFFER, d), y.vertexAttribPointer(l, u, p, h, g * f, M * f)
                            } else c.isInstancedBufferAttribute ? (y.enableAttributeAndDivisor(l, c.meshPerAttribute), void 0 === t.maxInstancedCount && (t.maxInstancedCount = c.meshPerAttribute * c.count)) : y.enableAttribute(l), v.bindBuffer(v.ARRAY_BUFFER, d), y.vertexAttribPointer(l, u, p, h, 0, 0)
                        } else if ("instanceMatrix" === s) {
                            var b;
                            if (void 0 === (b = S.get(e.instanceMatrix))) continue;
                            d = b.buffer, p = b.type;
                            y.enableAttributeAndDivisor(l + 0, 1), y.enableAttributeAndDivisor(l + 1, 1), y.enableAttributeAndDivisor(l + 2, 1), y.enableAttributeAndDivisor(l + 3, 1), v.bindBuffer(v.ARRAY_BUFFER, d), v.vertexAttribPointer(l + 0, 4, p, !1, 64, 0), v.vertexAttribPointer(l + 1, 4, p, !1, 64, 16), v.vertexAttribPointer(l + 2, 4, p, !1, 64, 32), v.vertexAttribPointer(l + 3, 4, p, !1, 64, 48)
                        } else if (void 0 !== o) {
                            var E = o[s];
            ...
            }(r, n, i, s), null !== c && v.bindBuffer(v.ELEMENT_ARRAY_BUFFER, u.buffer));
            var f = null !== c ? c.count : h.count,
                ...
                L = Math.max(0, T - E + 1);
            if (0 !== L) {
                if (r.isMesh) !0 === i.wireframe ? (y.setLineWidth(i.wireframeLinewidth * pe()), p.setMode(v.LINES)) : p.setMode(v.TRIANGLES);
                else if (r.isLine) {
                    var A = i.linewidth;
                    void 0 === A && (A = 1), y.setLineWidth(A * pe()), r.isLineSegments ? p.setMode(v.LINES) : r.isLineLoop ? p.setMode(v.LINE_LOOP) : p.setMode(v.LINE_STRIP)
                } else r.isPoints ? p.setMode(v.POINTS) : r.isSprite && p.setMode(v.TRIANGLES);
            ...
            (g = R.get(e, t)).init(), e.traverse((function(e) {
            ...
            e.traverse((function(t) {
                if (t.material)
                    if (Array.isArray(t.material))
                        for (var i = 0; i < t.material.length; i++) t.material[i].uuid in n == !1 && (De(t.material[i], e, t), n[t.material[i].uuid] = !0);
                    else t.material.uuid in n == !1 && (De(t.material, e, t), n[t.material.uuid] = !0)
            }))
        };
        var Te = null,
            Le = new be;
        ...
        function Ae(e, t, n, i) {
            if (!1 !== e.visible) {
                ...
                } else if (e.isImmediateRenderObject) i && de.setFromMatrixPosition(e.matrixWorld).applyMatrix4(ue), f.push(e, null, e.material, n, de.z, null);
                else if ((e.isMesh || e.isLine || e.isPoints) && (e.isSkinnedMesh && e.skeleton.frame !== M.render.frame && (e.skeleton.update(), e.skeleton.frame = M.render.frame), !e.frustumCulled || se.intersectsObject(e))) {
                    i && de.setFromMatrixPosition(e.matrixWorld).applyMatrix4(ue);
                    r = T.update(e);
                    var a = e.material;
                    if (Array.isArray(a))
                        ...
                        } else a.visible && f.push(e, r, a, n, de.z, null)
                }
                var u = e.children;
                for (s = 0, l = u.length; s < l; s++) Ae(u[s], t, n, i)
            }
        }
            ...
            for (var r = 0, a = e.length; r < a; r++) {
                ...
                if (n.isArrayCamera) {
                    ...
                    for (var u = n.cameras, d = 0, p = u.length; d < p; d++) {
                        var f = u[d];
                        s.layers.test(f.layers) && (y.viewport(q.copy(f.viewport)), g.setupLights(f), Pe(s, t, f, l, c, h))
                    }
                } else j = null, Pe(s, t, n, l, c, h)
            }
        }

        function Pe(e, t, n, i, r, a) {
            if (e.onBeforeRender(I, t, n, i, r, a), g = R.get(t, j || n), e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse, e.matrixWorld), e.normalMatrix.getNormalMatrix(e.modelViewMatrix), e.isImmediateRenderObject) {
                var o = Ce(n, t, r, e);
                y.setMaterial(r), W.geometry = null, W.program = null, W.wireframe = !1,
                    function(e, t) {
                        e.render((function(e) {
                            I.renderBufferImmediate(e, t)
                        }))
                    }(e, o)
            } else I.renderBufferDirect(n, t, i, r, e, a);
            e.onAfterRender(I, t, n, i, r, a), g = R.get(t, j || n)
        }
        ...
        function De(e, t, n) {
            var i = b.get(e),
                ...
                c = i.program,
                h = !0;
            if (void 0 === c) e.addEventListener("dispose", ye);
        ...
        function Ce(e, t, n, i) {
            ...
            n.version === l.__version ? void 0 === l.program || n.fog && l.fog !== a || l.environment !== o || l.needsLights && l.lightsStateVersion !== c.state.version ? De(n, t, i) : void 0 === l.numClippingPlanes || l.numClippingPlanes === le.numPlanes && l.numIntersection === le.numIntersection ? l.outputEncoding !== s && De(n, t, i) : De(n, t, i) : (De(n, t, i), l.__version = n.version);
            var d, p, f = !1,
                m = !1,
                _ = !1,
                M = l.program,
                S = M.getUniforms(),
                w = l.uniforms;
            if (y.useProgram(M.program) && (f = !0, m = !0, _ = !0), n.id !== k && (k = n.id, m = !0), f || X !== e) {
                if (S.setValue(v, "projectionMatrix", e.projectionMatrix), x.logarithmicDepthBuffer && S.setValue(v, "logDepthBufFC", 2 / (Math.log(e.far + 1) / Math.LN2)), X !== e && (X = e, m = !0, _ = !0), n.isShaderMaterial || n.isMeshPhongMaterial || n.isMeshToonMaterial || n.isMeshStandardMaterial || n.envMap) {
            ...
            if (n.skinning) {
                S.setOptional(v, i, "bindMatrix"), S.setOptional(v, i, "bindMatrixInverse");
                var L = i.skeleton;
                if (L) {
                    var A = L.bones;
                    if (x.floatVertexTextures) {
                        if (void 0 === L.boneTexture) {
                            ...
                            R = r.ceilPowerOfTwo(R), R = Math.max(R, 4);
                            var P = new Float32Array(R * R * 4);
                            P.set(L.boneMatrices);
                            var D = new u(P, R, R, 1023, 1015);
                            L.boneMatrices = P, L.boneTexture = D, L.boneTextureSize = R
                        }
                        S.setValue(v, "boneTexture", L.boneTexture, E), S.setValue(v, "boneTextureSize", L.boneTextureSize)
                    } else S.setOptional(v, L, "boneMatrices")
                }
            }
            return (m || l.receiveShadow !== i.receiveShadow) && (l.receiveShadow = i.receiveShadow, S.setValue(v, "receiveShadow", i.receiveShadow)), m && (S.setValue(v, "toneMappingExposure", I.toneMappingExposure), S.setValue(v, "toneMappingWhitePoint", I.toneMappingWhitePoint), l.needsLights && (p = _, (d = w).ambientLightColor.needsUpdate = p, d.lightProbe.needsUpdate = p, d.directionalLights.needsUpdate = p, d.directionalLightShadows.needsUpdate = p, d.pointLights.needsUpdate = p, d.pointLightShadows.needsUpdate = p, d.spotLights.needsUpdate = p, d.spotLightShadows.needsUpdate = p, d.rectAreaLights.needsUpdate = p, d.hemisphereLights.needsUpdate = p), a && n.fog && function(e, t) {
                e.fogColor.value.copy(t.color), t.isFog ? (e.fogNear.value = t.near, e.fogFar.value = t.far) : t.isFogExp2 && (e.fogDensity.value = t.density)
            }(w, a), n.isMeshBasicMaterial ? Ne(w, n) : n.isMeshLambertMaterial ? (Ne(w, n), function(e, t) {
                t.emissiveMap && (e.emissiveMap.value = t.emissiveMap)
            }(w, n)) : n.isMeshToonMaterial ? (Ne(w, n), function(e, t) {
            ...
            }(w, n)) : n.isMeshPhongMaterial ? (Ne(w, n), function(e, t) {
                ...
                t.normalMap && (e.normalMap.value = t.normalMap, e.normalScale.value.copy(t.normalScale), 1 === t.side && e.normalScale.value.negate());
                t.displacementMap && (e.displacementMap.value = t.displacementMap, e.displacementScale.value = t.displacementScale, e.displacementBias.value = t.displacementBias)
            }(w, n)) : n.isMeshStandardMaterial ? (Ne(w, n, o), n.isMeshPhysicalMaterial ? function(e, t, n) {
                Ue(e, t, n), e.reflectivity.value = t.reflectivity, e.clearcoat.value = t.clearcoat, e.clearcoatRoughness.value = t.clearcoatRoughness, t.sheen && e.sheen.value.copy(t.sheen);
            ...
            }(w, n, o) : Ue(w, n, o)) : n.isMeshMatcapMaterial ? (Ne(w, n), function(e, t) {
                t.matcap && (e.matcap.value = t.matcap);
                t.bumpMap && (e.bumpMap.value = t.bumpMap, e.bumpScale.value = t.bumpScale, 1 === t.side && (e.bumpScale.value *= -1));
                t.normalMap && (e.normalMap.value = t.normalMap, e.normalScale.value.copy(t.normalScale), 1 === t.side && e.normalScale.value.negate());
                t.displacementMap && (e.displacementMap.value = t.displacementMap, e.displacementScale.value = t.displacementScale, e.displacementBias.value = t.displacementBias)
            }(w, n)) : n.isMeshDepthMaterial ? (Ne(w, n), function(e, t) {
                t.displacementMap && (e.displacementMap.value = t.displacementMap, e.displacementScale.value = t.displacementScale, e.displacementBias.value = t.displacementBias)
            }(w, n)) : n.isMeshDistanceMaterial ? (Ne(w, n), function(e, t) {
                t.displacementMap && (e.displacementMap.value = t.displacementMap, e.displacementScale.value = t.displacementScale, e.displacementBias.value = t.displacementBias);
                e.referencePosition.value.copy(t.referencePosition), e.nearDistance.value = t.nearDistance, e.farDistance.value = t.farDistance
            }(w, n)) : n.isMeshNormalMaterial ? (Ne(w, n), function(e, t) {
                t.bumpMap && (e.bumpMap.value = t.bumpMap, e.bumpScale.value = t.bumpScale, 1 === t.side && (e.bumpScale.value *= -1));
                t.normalMap && (e.normalMap.value = t.normalMap, e.normalScale.value.copy(t.normalScale), 1 === t.side && e.normalScale.value.negate());
                t.displacementMap && (e.displacementMap.value = t.displacementMap, e.displacementScale.value = t.displacementScale, e.displacementBias.value = t.displacementBias)
                ...
                e.diffuse.value.copy(t.color), e.opacity.value = t.opacity, e.size.value = t.size * $, e.scale.value = .5 * K, t.map && (e.map.value = t.map);
                ...
                t.map ? n = t.map : t.alphaMap && (n = t.alphaMap);
                void 0 !== n && (!0 === n.matrixAutoUpdate && n.updateMatrix(), e.uvTransform.value.copy(n.matrix))
            }(w, n) : n.isShadowMaterial && (w.color.value.copy(n.color), w.opacity.value = n.opacity), void 0 !== w.ltc_1 && (w.ltc_1.value = te.LTC_1), void 0 !== w.ltc_2 && (w.ltc_2.value = te.LTC_2), ii.upload(v, l.uniformsList, w, E), n.isShaderMaterial && (n.uniformsNeedUpdate = !1)), n.isShaderMaterial && !0 === n.uniformsNeedUpdate && (ii.upload(v, l.uniformsList, w, E), n.uniformsNeedUpdate = !1), n.isSpriteMaterial && S.setValue(v, "center", i.center), S.setValue(v, "modelViewMatrix", i.modelViewMatrix), S.setValue(v, "normalMatrix", i.normalMatrix), S.setValue(v, "modelMatrix", i.matrixWorld), M
        }
        ...
        function Ne(e, t, n) {
            ...
            a && (e.envMap.value = a, e.flipEnvMap.value = a.isCubeTexture ? -1 : 1, e.reflectivity.value = t.reflectivity, e.refractionRatio.value = t.refractionRatio, e.maxMipLevel.value = b.get(a).__maxMipLevel), t.lightMap && (e.lightMap.value = t.lightMap, e.lightMapIntensity.value = t.lightMapIntensity), t.aoMap && (e.aoMap.value = t.aoMap, e.aoMapIntensity.value = t.aoMapIntensity), t.map ? i = t.map : t.specularMap ? i = t.specularMap : t.displacementMap ? i = t.displacementMap : t.normalMap ? i = t.normalMap : t.bumpMap ? i = t.bumpMap : t.roughnessMap ? i = t.roughnessMap : t.metalnessMap ? i = t.metalnessMap : t.alphaMap ? i = t.alphaMap : t.emissiveMap && (i = t.emissiveMap), void 0 !== i && (i.isWebGLRenderTarget && (i = i.texture), !0 === i.matrixAutoUpdate && i.updateMatrix(), e.uvTransform.value.copy(i.matrix)), t.aoMap ? r = t.aoMap : t.lightMap && (r = t.lightMap), void 0 !== r && (r.isWebGLRenderTarget && (r = r.texture), !0 === r.matrixAutoUpdate && r.updateMatrix(), e.uv2Transform.value.copy(r.matrix))
        }
        ...
        Le.setAnimationLoop((function(e) {
            ...
            Te = e, ge.setAnimationLoop(e), Le.start()
            ...
            if (void 0 !== arguments[2] && (console.warn("THREE.WebGLRenderer.render(): the renderTarget argument has been removed. Use .setRenderTarget() instead."), n = arguments[2]), void 0 !== arguments[3] && (console.warn("THREE.WebGLRenderer.render(): the forceClear argument has been removed. Use .clear() instead."), i = arguments[3]), t && t.isCamera) {
                if (!F) {
                    W.geometry = null, W.program = null, W.wireframe = !1, k = -1, X = null, !0 === e.autoUpdate && e.updateMatrixWorld(), null === t.parent && t.updateMatrixWorld(), ge.enabled && ge.isPresenting && (t = ge.getCamera(t)), e.onBeforeRender(I, e, t, n || H), (g = R.get(e, t)).init(), ue.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), se.setFromProjectionMatrix(ue), he = this.localClippingEnabled, ce = le.init(this.clippingPlanes, he, t), (f = A.get(e, t)).init(), Ae(e, t, 0, I.sortObjects), f.finish(), !0 === I.sortObjects && f.sort(ee, ie), ce && le.beginShadows();
                    var r = g.state.shadowsArray;
                    ve.render(r, e, t), g.setupLights(t), ce && le.endShadows(), this.info.autoReset && this.info.reset(), void 0 !== n && this.setRenderTarget(n), P.render(f, e, t, i);
                    var a = f.opaque,
                        o = f.transparent;
                    if (e.overrideMaterial) {
                        var s = e.overrideMaterial;
                        a.length && Re(a, e, t, s), o.length && Re(o, e, t, s)
                    } else a.length && Re(a, e, t), o.length && Re(o, e, t);
                    e.onAfterRender(I, e, t), null !== H && (E.updateRenderTargetMipmap(H), E.updateMultisampleRenderTarget(H)), y.buffers.depth.setTest(!0), y.buffers.depth.setMask(!0), y.buffers.color.setMask(!0), y.setPolygonOffset(!1), f = null, g = null
                }
            } else console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.")
        }, this.setFramebuffer = function(e) {
            O !== e && null === H && v.bindFramebuffer(v.FRAMEBUFFER, e), O = e
            ...
            H = e, z = t, G = n, e && void 0 === b.get(e).__webglFramebuffer && E.setupRenderTarget(e);
            var i = O,
                r = !1;
            if (e) {
                var a = b.get(e).__webglFramebuffer;
                e.isWebGLCubeRenderTarget ? (i = a[t || 0], r = !0) : i = e.isWebGLMultisampleRenderTarget ? b.get(e).__webglMultisampledFramebuffer : a, q.copy(e.viewport), Z.copy(e.scissor), J = e.scissorTest
            } else q.copy(re).multiplyScalar($).floor(), Z.copy(ae).multiplyScalar($).floor(), J = oe;
            if (V !== i && (v.bindFramebuffer(v.FRAMEBUFFER, i), V = i), y.viewport(q), y.scissor(Z), y.setScissorTest(J), r) {
            ...
            if (e && e.isWebGLRenderTarget) {
                ...
                if (e.isWebGLCubeRenderTarget && void 0 !== o && (s = s[o]), s) {
                    var l = !1;
                    s !== V && (v.bindFramebuffer(v.FRAMEBUFFER, s), l = !0);
                    try {
                        var c = e.texture,
                            h = c.format,
                            u = c.type;
                        if (1023 !== h && U.convert(h) !== v.getParameter(v.IMPLEMENTATION_COLOR_READ_FORMAT)) return void console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");
                        if (!(1009 === u || U.convert(u) === v.getParameter(v.IMPLEMENTATION_COLOR_READ_TYPE) || 1015 === u && (x.isWebGL2 || _.get("OES_texture_float") || _.get("WEBGL_color_buffer_float")) || 1016 === u && (x.isWebGL2 ? _.get("EXT_color_buffer_float") : _.get("EXT_color_buffer_half_float")))) return void console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");
            ...
            E.setTexture2D(t, 0), v.copyTexImage2D(v.TEXTURE_2D, n, o, e.x, e.y, r, a, 0), y.unbindTexture()
            ...
            var r = t.image.width,
                ...
                s = U.convert(n.type);
            E.setTexture2D(n, 0), t.isDataTexture ? v.texSubImage2D(v.TEXTURE_2D, i, e.x, e.y, r, a, o, s, t.image.data) : t.isCompressedTexture ? v.compressedTexSubImage2D(v.TEXTURE_2D, i, e.x, e.y, t.mipmaps[0].width, t.mipmaps[0].height, o, t.mipmaps[0].data) : v.texSubImage2D(v.TEXTURE_2D, i, e.x, e.y, o, s, t.image), 0 === i && n.generateMipmaps && v.generateMipmap(v.TEXTURE_2D), y.unbindTexture()
        }, this.initTexture = function(e) {
            E.setTexture2D(e, 0), y.unbindTexture()
